var so = class {
	constructor() {
		this.listeners = [], this.unexpectedErrorHandler = function(e) {
			setTimeout(() => {
				throw e.stack ? Zn.isErrorNoTelemetry(e) ? new Zn(e.message + `
...
function Qn(e) {
	if (e instanceof Error) {
		...
		return {
			...
			noTelemetry: Zn.isErrorNoTelemetry(e),
			cause: r ? Qn(r) : void 0,
			code: e.code
		};
	}
...
const oo = "Canceled";
function lo(e) {
	return e instanceof ra ? !0 : e instanceof Error && e.name === "Canceled" && e.message === "Canceled";
}
var ra = class extends Error {
	constructor() {
		super(oo), this.name = this.message;
	}
}, Zn = class Yn extends Error {
	constructor(t) {
...
}, ue = class ia extends Error {
	constructor(t) {
		super(t || "An unexpected bug occurred."), Object.setPrototypeOf(this, ia.prototype);
	}
};
function uo(e, t = "Unreachable") {
	throw new Error(t);
}
function co(e, t = "unexpected state") {
	if (!e) throw typeof t == "string" ? new ue(`Assertion Failed: ${t}`) : t;
}
function pn(e) {
	if (!e()) {
		debugger;
		e(), tn(new ue("Assertion Failed"));
	}
}
function sa(e, t) {
	let n = 0;
...
(function(e) {
	...
	e.flatMap = p;
	function* v(..._) {
		for (const T of _) ho(T) ? yield* T : yield T;
	}
	e.concat = v;
	function S(_, T, I) {
		let D = I;
...
var zr = class oa {
	...
	add(t) {
		if (!t || t === Ut.None) return t;
		if (t === this) throw new Error("Cannot register a disposable on itself!");
		return this._isDisposed ? oa.DISABLE_DISPOSED_WARNING || console.warn((/* @__PURE__ */ new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!")).stack) : this._toDispose.add(t), t;
	}
	delete(t) {
		if (t) {
	...
	constructor() {
		this._store = new zr(), this._store;
	}
	dispose() {
		this._store.dispose();
	}
...
const bo = globalThis.performance.now.bind(globalThis.performance);
var la = class ua {
	static create(t) {
		return new ua(t);
	}
	constructor(t) {
		this._now = t === !1 ? Date.now : bo, this._startTime = this._now(), this._stopTime = -1;
	}
	stop() {
...
(function(e) {
	...
	function n(L) {
		return (R, P = null, C) => {
			let F = !1, V;
			return V = L((q) => {
				if (!F) return V ? V.dispose() : F = !0, R.call(P, q);
	...
	e.onceIf = r;
	function i(L, R, P) {
		return h((C, F = null, V) => L((q) => C.call(F, R(q)), null, V), P);
	}
	e.map = i;
	function s(L, R, P) {
		return h((C, F = null, V) => L((q) => {
			R(q), C.call(F, q);
		}, null, V), P);
	}
	e.forEach = s;
	function a(L, R, P) {
		return h((C, F = null, V) => L((q) => R(q) && C.call(F, q), null, V), P);
	}
	e.filter = a;
	function l(L) {
		return L;
	...
	e.signal = l;
	function o(...L) {
		return (R, P = null, C) => f(mo(...L.map((F) => F((V) => R.call(P, V)))), C);
	}
	e.any = o;
	function u(L, R, P, C) {
		let F = P;
	...
	function g(L, R, P = 100, C = !1, F = !1, V, q) {
		let G, W, ve, Gt = 0, kt;
		const Jt = new Me({
			leakWarningThreshold: V,
			onWillAddFirstListener() {
				G = L((ro) => {
					Gt++, W = R(W, ro), C && !ve && (Jt.fire(W), W = void 0), kt = () => {
						const io = W;
						W = void 0, ve = void 0, (!C || Gt > 1) && Jt.fire(io), Gt = 0;
					}, typeof P == "number" ? (ve && clearTimeout(ve), ve = setTimeout(kt, P)) : ve === void 0 && (ve = null, queueMicrotask(kt));
				});
			},
	...
	function w(L, R, P = (C) => C) {
		const C = (...G) => q.fire(P(...G)), F = () => L.on(R, C), V = () => L.removeListener(R, C), q = new Me({
	...
	function y(L, R, P = (C) => C) {
		const C = (...G) => q.fire(P(...G)), F = () => L.addEventListener(R, C), V = () => L.removeEventListener(R, C), q = new Me({
			onWillAddFirstListener: F,
			onDidRemoveLastListener: V
		});
		return q.event;
	...
	class I {
		constructor(R, P) {
			this._observable = R, this._counter = 0, this._hasChanged = !1, this.emitter = new Me({
				onWillAddFirstListener: () => {
	...
	function M(L) {
		return (R, P, C) => {
			...
			L.addObserver(q), L.reportChanges();
			const G = { dispose() {
				L.removeObserver(q);
			} };
			return C instanceof zr ? C.add(G) : Array.isArray(C) && C.push(G), G;
		};
	}
...
var yo = class er {
	...
	constructor(t) {
		this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${t}_${er._idPool++}`, er.all.add(this);
	}
	start(t) {
		this._stopWatch = new la(), this.listenerCount = t;
	}
	stop() {
		if (this._stopWatch) {
...
var wo = class ca {
	...
	constructor(t, n, r = (ca._idPool++).toString(16).padStart(3, "0")) {
	...
	static create() {
		return new fa((/* @__PURE__ */ new Error()).stack ?? "");
	}
	constructor(t) {
		this.value = t;
	}
...
var Me = class {
	constructor(e) {
		this._size = 0, this._options = e, this._leakageMon = this._options?.leakWarningThreshold ? new wo(e?.onListenerError ?? tn, this._options?.leakWarningThreshold ?? vo) : void 0, this._perfMon = this._options?._profName ? new yo(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
	}
	dispose() {
	...
	get event() {
		return this._event ??= (e, t, n) => {
			if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
				...
				console.warn(a);
				const l = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], o = new No(`${a}. HINT: Stack shows most frequent listener (${l[1]}-times)`, l[0]);
				return (this._options?.onListenerError || tn)(o), Ut.None;
			}
			if (this._disposed) return Ut.None;
			t && (e = e.bind(t));
			const r = new In(e);
			let i;
			this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * .2) && (r.stack = _o.create(), i = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof In ? (this._deliveryQueue ??= new Ao(), this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
			const s = yn(() => {
				i?.(), this._removeListener(r);
			});
			return n instanceof zr ? n.add(s) : Array.isArray(n) && n.push(s), s;
		}, this._event;
	}
	_removeListener(e) {
	...
	_deliver(e, t) {
		if (!e) return;
		const n = this._options?.onListenerError || tn;
		if (!n) {
			e.value(t);
			return;
		}
...
const xo = ha() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
function Kr(e, t) {
	let n;
...
function $(e, t, ...n) {
	return Kr(typeof e == "number" ? Ro(e, t) : t, n);
}
function Ro(e, t) {
	const n = ko()?.[e];
	if (typeof n != "string") {
...
let vn = !1, wn = !1, rn = !1, ma = !1, Fe;
const $e = globalThis;
let he;
typeof $e.vscode < "u" && typeof $e.vscode.process < "u" ? he = $e.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (he = process);
const Po = typeof he?.versions?.electron == "string" && he?.type === "renderer";
if (typeof he == "object") {
	vn = he.platform === "win32", wn = he.platform === "darwin", rn = he.platform === "linux", rn && he.env.SNAP && he.env.SNAP_REVISION, he.env.CI || he.env.BUILD_ARTIFACTSTAGINGDIRECTORY || he.env.GITHUB_WORKSPACE;
	const e = he.env.VSCODE_NLS_CONFIG;
	if (e) try {
		const t = JSON.parse(e);
		t.userLocale, t.osLocale, t.resolvedLanguage, t.languagePack?.translationsConfigFile;
	} catch {}
} else typeof navigator == "object" && !Po ? (Fe = navigator.userAgent, vn = Fe.indexOf("Windows") >= 0, wn = Fe.indexOf("Macintosh") >= 0, (Fe.indexOf("Macintosh") >= 0 || Fe.indexOf("iPad") >= 0 || Fe.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints, rn = Fe.indexOf("Linux") >= 0, Fe?.indexOf("Mobi"), ma = !0, ha(), navigator.language.toLowerCase()) : console.error("Unable to resolve platform.");
const qt = vn, Co = wn;
ma && typeof $e.importScripts == "function" && $e.origin;
const Te = Fe, Fo = typeof $e.postMessage == "function" && !$e.importScripts;
(() => {
	if (Fo) {
		const e = [];
		...
		return (n) => {
			...
			e.push({
				id: r,
				callback: n
			}), $e.postMessage({ vscodeScheduleAsyncWork: r }, "*");
		};
	}
	return (e) => setTimeout(e);
})();
const Do = !!(Te && Te.indexOf("Chrome") >= 0);
Te && Te.indexOf("Firefox");
!Do && Te && Te.indexOf("Safari");
Te && Te.indexOf("Edg/");
...
var $o = class {
	constructor(e, t) {
		this.lastCache = void 0, this.lastArgKey = void 0, typeof e == "function" ? (this._fn = e, this._computeKey = Oo) : (this._fn = t, this._computeKey = e.getCacheKey);
	}
	get(e) {
...
var rr = class It {
	...
	static {
		this.cache = new $o({ getCacheKey: JSON.stringify }, (t) => {
			function n(o) {
	...
	static {
		this._locales = new tr(() => Object.keys(It.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
	}
	static getLocales() {
	...
	static getData() {
		return this._data || (this._data = new Set([...Object.values(sn.getRawData())].flat())), this._data;
	}
	static isInvisibleCharacter(t) {
		return sn.getData().has(t);
	}
	static get codePoints() {
		return sn.getData();
	}
};
const On = "default", Zo = "$initialize";
var Yo = class {
	...
	async sendMessage(e, t, n) {
		...
		return new Promise((i, s) => {
			this._pendingReplies[r] = {
				resolve: i,
				reject: s
			}, this._send(new Yo(this._workerId, r, e, t, n));
		});
	}
	listen(e, t, n) {
		let r = null;
		const i = new Me({
			onWillAddFirstListener: () => {
				r = String(++this._lastSentReq), this._pendingEmitters.set(r, i), this._send(new Ko(this._workerId, r, e, t, n));
			},
			onDidRemoveLastListener: () => {
	...
	createProxyToRemoteChannel(e, t) {
		return new Proxy(Object.create(null), { get: (n, r) => (typeof r == "string" && !n[r] && (ba(r) ? n[r] = (i) => this.listen(e, r, i) : pa(r) ? n[r] = this.listen(e, r, void 0) : r.charCodeAt(0) === 36 && (n[r] = async (...i) => (await t?.(), this.sendMessage(e, r, i)))), n[r]) });
	}
	_handleMessage(e) {
		switch (e.type) {
	...
	_handleRequestMessage(e) {
		...
		this._handler.handleMessage(e.channel, e.method, e.args).then((n) => {
			this._send(new ei(this._workerId, t, n, void 0));
		}, (n) => {
			n.detail instanceof Error && (n.detail = Qn(n.detail)), this._send(new ei(this._workerId, t, void 0, Qn(n)));
		});
	}
...
function pa(e) {
	return e[0] === "o" && e[1] === "n" && ga(e.charCodeAt(2));
}
function ba(e) {
	return /^onDynamic/.test(e) && ga(e.charCodeAt(9));
}
var rl = class {
	constructor(e, t) {
		this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._protocol = new nl({
			sendMessage: (n, r) => {
				e(n, r);
			},
	...
	_handleMessage(e, t, n) {
		if (e === On && t === Zo) return this.initialize(n[0]);
...
let ti = !1;
function il(e) {
	if (ti) throw new Error("WebWorker already initialized!");
	ti = !0;
	const t = new rl((n) => globalThis.postMessage(n), (n) => e(n));
...
const ni = typeof Buffer < "u";
new tr(() => new Uint8Array(256));
let $n;
var sl = class ya {
	static wrap(t) {
		return ni && !Buffer.isBuffer(t) && (t = Buffer.from(t.buffer, t.byteOffset, t.byteLength)), new ya(t);
	}
	constructor(t) {
		this.buffer = t, this.byteLength = this.buffer.byteLength;
	}
	toString() {
		return ni ? this.buffer.toString() : ($n || ($n = new TextDecoder()), $n.decode(this.buffer));
	}
};
const ri = "0123456789abcdef";
function al({ buffer: e }) {
	let t = "";
...
function ol(e, t) {
	t = ii(149417, t);
	for (let n = 0, r = e.length; n < r; n++) t = ii(e.charCodeAt(n), t);
	return t;
}
...
function xt(e, t = 32) {
	return e instanceof ArrayBuffer ? al(sl.wrap(new Uint8Array(e))) : (e >>> 0).toString(16).padStart(t / 4, "0");
}
(class va {
	static {
	...
	digest() {
		return this._finished || (this._finished = !0, this._leftoverHighSurrogate && (this._leftoverHighSurrogate = 0, this._buffLen = this._push(this._buff, this._buffLen, 65533)), this._totalLen += this._buffLen, this._wrapUp()), xt(this._h0) + xt(this._h1) + xt(this._h2) + xt(this._h3) + xt(this._h4);
	}
	_wrapUp() {
	...
	_step() {
		const t = va._bigBlock32, n = this._buffDV;
		for (let f = 0; f < 64; f += 4) t.setUint32(f, n.getUint32(f, !1), !1);
		for (let f = 64; f < 320; f += 4) t.setUint32(f, Bn(t.getUint32(f - 12, !1) ^ t.getUint32(f - 32, !1) ^ t.getUint32(f - 56, !1) ^ t.getUint32(f - 64, !1), 1), !1);
		let r = this._h0, i = this._h1, s = this._h2, a = this._h3, l = this._h4, o, u, h;
		for (let f = 0; f < 80; f++) f < 20 ? (o = i & s | ~i & a, u = 1518500249) : f < 40 ? (o = i ^ s ^ a, u = 1859775393) : f < 60 ? (o = i & s | i & a | s & a, u = 2400959708) : (o = i ^ s ^ a, u = 3395469782), h = Bn(r, 5) + o + l + u + t.getUint32(f * 4, !1) & 4294967295, l = a, a = s, s = Bn(i, 30), i = r, r = h;
...
function ll(e, t, n) {
	return new wa(new si(e), new si(t)).ComputeDiff(n).changes;
}
var it = class {
	static Assert(e, t) {
	...
	static _getElements(t) {
		...
		if (mt._isStringArray(n)) {
			...
			for (let i = 0, s = n.length; i < s; i++) r[i] = ol(n[i], 0);
			return [
				n,
				r,
				!0
	...
	ComputeDiffRecursive(t, n, r, i, s) {
		...
		if (t > n || r > i) {
			let f;
			return r <= i ? (it.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), f = [new je(t, 0, r, i - r + 1)]) : t <= n ? (it.Assert(r === i + 1, "modifiedStart should only be one more than modifiedEnd"), f = [new je(t, n - t + 1, r, 0)]) : (it.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), it.Assert(r === i + 1, "modifiedStart should only be one more than modifiedEnd"), f = []), f;
		}
		...
		if (!s[0]) {
			...
			let g = [];
			return s[0] ? g = [new je(u + 1, n - (u + 1) + 1, h + 1, i - (h + 1) + 1)] : g = this.ComputeDiffRecursive(u + 1, n, h + 1, i, s), this.ConcatenateChanges(f, g);
		}
		return [new je(t, n - t + 1, r, i - r + 1)];
	}
	WALKTRACE(t, n, r, i, s, a, l, o, u, h, f, g, m, d, p, v, S, N) {
		let b = null, w = null, y = new ai(), A = n, _ = r, T = m[0] - v[0] - i, I = -1073741824, D = this.m_forwardHistory.length - 1;
		do {
			const M = T + t;
		...
		if (b = y.getReverseChanges(), N[0]) {
			...
			w = [new je(M, g - M + 1, L, p - L + 1)];
		} else {
			y = new ai(), A = a, _ = l, T = m[0] - v[0] - o, I = 1073741824, D = S ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
			do {
				const M = T + s;
	...
	ComputeRecursionPoint(t, n, r, i, s, a, l) {
		...
		for (let _ = 1; _ <= d / 2 + 1; _++) {
			...
			const D = (T - t + (I - r) - _) / 2;
			if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(T, D)) return l[0] = !0, s[0] = T, a[0] = I, D > 0 && _ <= 1448 ? this.WALKTRACE(N, h, f, w, b, g, m, y, v, S, o, n, s, u, i, a, A, l) : (t++, r++, [new je(t, n - t + 1, r, i - r + 1)]);
	...
	ChangesOverlap(t, n, r) {
		if (it.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), it.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
			...
			return t.originalStart + t.originalLength >= n.originalStart && (s = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (l = n.modifiedStart + n.modifiedLength - t.modifiedStart), r[0] = new je(i, s, a, l), !0;
...
var ul = class _a {
	constructor(t) {
		const n = oi(t);
		this._defaultValue = n, this._asciiMap = _a._createAsciiMap(n), this._map = /* @__PURE__ */ new Map();
	}
...
function ml() {
	if (Rt === null) {
		Rt = new ul(0);
		const e = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…|`;
		for (let n = 0; n < 36; n++) Rt.set(e.charCodeAt(n), 1);
		const t = ".,;:";
		for (let n = 0; n < 4; n++) Rt.set(t.charCodeAt(n), 2);
	}
	return Rt;
}
var gl = class ir {
		...
		for (let s = 1, a = t.getLineCount(); s <= a; s++) {
			...
			for (; u < o;) {
				...
				if (g === 13) {
					...
					b === 1 && (i.push(ir._createLink(r, l, s, h, u)), S = !0);
				} else if (g === 12) {
					let b;
			...
			g === 13 && i.push(ir._createLink(r, l, s, h, o));
		}
		return i;
	}
};
function dl(e) {
	return !e || typeof e.getLineCount != "function" || typeof e.getLineContent != "function" ? [] : gl.computeLinks(e);
}
var pl = class La {
	constructor() {
...
var an = class {
	...
	get onCancellationRequested() {
		return this._isCancelled ? Na : (this._emitter || (this._emitter = new Me()), this._emitter.event);
	}
	dispose() {
	...
	cancel() {
		this._token ? this._token instanceof an && this._token.cancel() : this._token = Ln.Cancelled;
	}
	dispose(e = !1) {
		e && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof an && this._token.dispose() : this._token = Ln.None;
	}
}, Gr = class {
	constructor() {
...
const on = new Gr(), sr = new Gr(), ar = new Gr(), yl = new Array(230), vl = Object.create(null), wl = Object.create(null), Sa = [];
for (let e = 0; e <= 193; e++) Sa[e] = -1;
(function() {
	const t = [
		[
			1,
	...
	for (const i of t) {
		...
		if (r[a] || (r[a] = !0, vl[l] = a, wl[l.toLowerCase()] = a, s && (Sa[a] = o)), !n[o]) {
			if (n[o] = !0, !u) throw new Error(`String representation missing for key code ${o} around scan code ${l}`);
			on.define(o, u), sr.define(o, g || u), ar.define(o, m || g || u);
		}
		h && (yl[h] = o);
	}
})();
...
(function(e) {
	...
	function i(l) {
		return ar.keyCodeToStr(l);
	}
	e.toUserSettingsGeneral = i;
	function s(l) {
		return sr.strToKeyCode(l) || ar.strToKeyCode(l);
	}
...
if (typeof qn < "u" && typeof qn.process < "u") {
...
} else typeof process < "u" && typeof process?.versions?.node == "string" ? pt = {
	get platform() {
	...
	get platform() {
		return qt ? "win32" : Co ? "darwin" : "linux";
	},
	get arch() {},
	get env() {
		return {};
...
const Nn = pt.cwd, Ll = pt.env, Nl = pt.platform, Sl = 65, Al = 97, kl = 90, xl = 122, Ke = 46, ae = 47, fe = 92, Ce = 58, Rl = 63;
...
function Ml(e, t) {
	if (e === null || typeof e != "object") throw new Aa(t, "Object", e);
}
function K(e, t) {
	if (typeof e != "string") throw new Aa(t, "string", e);
}
const Ge = Nl === "win32";
function B(e) {
	return e === ae || e === fe;
...
function ka(e, t) {
	Ml(t, "pathObject");
	const n = t.dir || t.root, r = t.base || `${t.name || ""}${El(t.ext)}`;
...
const ce = {
	resolve(...e) {
		...
		for (let i = e.length - 1; i >= -1; i--) {
			...
			} else t.length === 0 ? s = Nn() : (s = Ll[`=${t}`] || Nn(), (s === void 0 || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === fe) && (s = `${t}\\`));
			const a = s.length;
			let l = 0, o = "", u = !1;
			const h = s.charCodeAt(0);
			if (a === 1) B(h) && (l = 1, u = !0);
			else if (B(h)) if (u = !0, B(s.charCodeAt(1))) {
				let f = 2, g = f;
				for (; f < a && !B(s.charCodeAt(f));) f++;
				if (f < a && f !== g) {
					const m = s.slice(g, f);
					for (g = f; f < a && B(s.charCodeAt(f));) f++;
					if (f < a && f !== g) {
						for (g = f; f < a && !B(s.charCodeAt(f));) f++;
			...
			else Ie(h) && s.charCodeAt(1) === Ce && (o = s.slice(0, 2), l = 2, a > 2 && B(s.charCodeAt(2)) && (u = !0, l = 3));
	...
	normalize(e) {
		...
		if (t === 1) return or(s) ? "\\" : e;
		if (B(s)) if (i = !0, B(e.charCodeAt(1))) {
			let l = 2, o = l;
			for (; l < t && !B(e.charCodeAt(l));) l++;
			if (l < t && l !== o) {
				const u = e.slice(o, l);
				for (o = l; l < t && B(e.charCodeAt(l));) l++;
				if (l < t && l !== o) {
					for (o = l; l < t && !B(e.charCodeAt(l));) l++;
		...
		else Ie(s) && e.charCodeAt(1) === Ce && (r = e.slice(0, 2), n = 2, t > 2 && B(e.charCodeAt(2)) && (i = !0, n = 3));
		let a = n < t ? Sn(e.slice(n), !i, "\\", B) : "";
		if (a.length === 0 && !i && (a = "."), a.length > 0 && B(e.charCodeAt(t - 1)) && (a += "\\"), !i && r === void 0 && e.includes(":")) {
			if (a.length >= 2 && Ie(a.charCodeAt(0)) && a.charCodeAt(1) === Ce) return `.\\${a}`;
			let l = e.indexOf(":");
			do
				if (l === t - 1 || B(e.charCodeAt(l + 1))) return `.\\${a}`;
	...
	isAbsolute(e) {
		...
		return B(n) || t > 2 && Ie(n) && e.charCodeAt(1) === Ce && B(e.charCodeAt(2));
	},
	join(...e) {
	...
	relative(e, t) {
		...
		if (g !== h) {
			...
			if (u > h) {
				if (t.charCodeAt(l + g) === fe) return r.slice(l + g + 1);
				if (g === 2) return r.slice(l + g);
			}
			a > h && (e.charCodeAt(i + g) === fe ? f = g : g === 2 && (f = 3)), f === -1 && (f = 0);
		}
		let m = "";
		for (g = i + f + 1; g <= s; ++g) (g === s || e.charCodeAt(g) === fe) && (m += m.length === 0 ? ".." : "\\..");
		return l += f, m.length > 0 ? `${m}${r.slice(l, o)}` : (r.charCodeAt(l) === fe && ++l, r.slice(l, o));
	},
	toNamespacedPath(e) {
		...
		if (t.charCodeAt(0) === fe) {
			if (t.charCodeAt(1) === fe) {
				...
				if (n !== Rl && n !== Ke) return `\\\\?\\UNC\\${t.slice(2)}`;
			}
		} else if (Ie(t.charCodeAt(0)) && t.charCodeAt(1) === Ce && t.charCodeAt(2) === fe) return `\\\\?\\${t}`;
		return t;
	},
	dirname(e) {
		K(e, "path");
		...
		} else Ie(i) && e.charCodeAt(1) === Ce && (n = t > 2 && B(e.charCodeAt(2)) ? 3 : 2, r = n);
		let s = -1, a = !0;
		for (let l = t - 1; l >= r; --l) if (B(e.charCodeAt(l))) {
			if (!a) {
				s = l;
				break;
			}
	...
	basename(e, t) {
		...
		let n = 0, r = -1, i = !0, s;
		if (e.length >= 2 && Ie(e.charCodeAt(0)) && e.charCodeAt(1) === Ce && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
			if (t === e) return "";
	...
	extname(e) {
		...
		e.length >= 2 && e.charCodeAt(1) === Ce && Ie(e.charCodeAt(0)) && (t = r = 2);
		for (let l = e.length - 1; l >= t; --l) {
			...
			i === -1 && (s = !1, i = l + 1), o === Ke ? n === -1 ? n = l : a !== 1 && (a = 1) : n !== -1 && (a = -1);
		}
	...
	parse(e) {
		...
		if (B(i)) {
			if (r = 1, B(e.charCodeAt(1))) {
				let f = 2, g = f;
				for (; f < n && !B(e.charCodeAt(f));) f++;
				if (f < n && f !== g) {
					for (g = f; f < n && B(e.charCodeAt(f));) f++;
					if (f < n && f !== g) {
						for (g = f; f < n && !B(e.charCodeAt(f));) f++;
						f === n ? r = f : f !== g && (r = f + 1);
					}
		...
		} else if (Ie(i) && e.charCodeAt(1) === Ce) {
		...
		for (; u >= r; --u) {
			...
			l === -1 && (o = !1, l = u + 1), i === Ke ? s === -1 ? s = u : h !== 1 && (h = 1) : s !== -1 && (h = -1);
		}
	...
	resolve(...e) {
		...
		for (let r = e.length - 1; r >= 0 && !n; r--) {
			const i = e[r];
			K(i, `paths[${r}]`), i.length !== 0 && (t = `${i}/${t}`, n = i.charCodeAt(0) === ae);
		}
		if (!n) {
			const r = Tl();
			t = `${r}/${t}`, n = r.charCodeAt(0) === ae;
		}
		return t = Sn(t, !n, "/", or), n ? `/${t}` : t.length > 0 ? t : ".";
	},
	normalize(e) {
		if (K(e, "path"), e.length === 0) return ".";
		const t = e.charCodeAt(0) === ae, n = e.charCodeAt(e.length - 1) === ae;
		return e = Sn(e, !t, "/", or), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
	},
	isAbsolute(e) {
	...
	relative(e, t) {
		...
		if (u === l) if (a > l) {
			if (t.charCodeAt(s + u) === ae) return t.slice(s + u + 1);
			if (u === 0) return t.slice(s + u);
		} else i > l && (e.charCodeAt(n + u) === ae ? o = u : u === 0 && (o = 0));
		let h = "";
		for (u = n + o + 1; u <= r; ++u) (u === r || e.charCodeAt(u) === ae) && (h += h.length === 0 ? ".." : "/..");
	...
	dirname(e) {
		...
		let n = -1, r = !0;
		for (let i = e.length - 1; i >= 1; --i) if (e.charCodeAt(i) === ae) {
			if (!r) {
				n = i;
				break;
			}
	...
	basename(e, t) {
		...
		for (s = e.length - 1; s >= 0; --s) if (e.charCodeAt(s) === ae) {
			if (!i) {
				n = s + 1;
				break;
			}
	...
	parse(e) {
		...
		for (; o >= r; --o) {
			...
			a === -1 && (l = !1, a = o + 1), h === Ke ? i === -1 ? i = o : u !== 1 && (u = 1) : i !== -1 && (u = -1);
		}
		if (a !== -1) {
			const h = s === 0 && n ? 1 : s;
...
Ge ? ce.normalize : me.normalize;
Ge ? ce.resolve : me.resolve;
Ge ? ce.relative : me.relative;
Ge ? ce.dirname : me.dirname;
Ge ? ce.basename : me.basename;
Ge ? ce.extname : me.extname;
Ge ? ce.sep : me.sep;
const Pl = /^\w[\w\d+.-]*$/, Cl = /^\//, Il = /^\/\//;
function Fl(e, t) {
	...
	if (e.scheme && !Pl.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
	if (e.path) {
		if (e.authority) {
			if (!Cl.test(e.path)) throw new Error("[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash (\"/\") character");
		} else if (Il.test(e.path)) throw new Error("[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters (\"//\")");
	}
}
function Vl(e, t) {
	return !e && !t ? "file" : e;
...
var Jr = class ln {
	static isUri(t) {
		return t instanceof ln ? !0 : !t || typeof t != "object" ? !1 : typeof t.authority == "string" && typeof t.fragment == "string" && typeof t.path == "string" && typeof t.query == "string" && typeof t.scheme == "string" && typeof t.fsPath == "string" && typeof t.with == "function" && typeof t.toString == "function";
	}
	constructor(t, n, r, i, s, a = !1) {
		typeof t == "object" ? (this.scheme = t.scheme || Q, this.authority = t.authority || Q, this.path = t.path || Q, this.query = t.query || Q, this.fragment = t.fragment || Q) : (this.scheme = Vl(t, a), this.authority = n || Q, this.path = Dl(this.scheme, r || Q), this.query = i || Q, this.fragment = s || Q, Fl(this, a));
	}
	get fsPath() {
		return lr(this, !1);
	}
	with(t) {
		...
		return n === void 0 ? n = this.scheme : n === null && (n = Q), r === void 0 ? r = this.authority : r === null && (r = Q), i === void 0 ? i = this.path : i === null && (i = Q), s === void 0 ? s = this.query : s === null && (s = Q), a === void 0 ? a = this.fragment : a === null && (a = Q), n === this.scheme && r === this.authority && i === this.path && s === this.query && a === this.fragment ? this : new ot(n, r, i, s, a);
	}
	static parse(t, n = !1) {
		const r = Ol.exec(t);
		return r ? new ot(r[2] || Q, Xt(r[4] || Q), Xt(r[5] || Q), Xt(r[7] || Q), Xt(r[9] || Q), n) : new ot(Q, Q, Q, Q, Q);
	}
	static file(t) {
		let n = Q;
		if (qt && (t = t.replace(/\\/g, Ae)), t[0] === Ae && t[1] === Ae) {
			const r = t.indexOf(Ae, 2);
			r === -1 ? (n = t.substring(2), t = Ae) : (n = t.substring(2, r), t = t.substring(r) || Ae);
		}
		return new ot("file", n, t, Q, Q);
	}
	static from(t, n) {
	...
	static joinPath(t, ...n) {
		...
		let r;
		return qt && t.scheme === "file" ? r = ln.file(ce.join(lr(t, !0), ...n)).path : r = me.join(t.path, ...n), t.with({ path: r });
	}
	toString(t = !1) {
		return ur(this, t);
	}
	...
	static revive(t) {
		if (t) {
			...
			{
				const n = new ot(t);
				return n._formatted = t.external ?? null, n._fsPath = t._sep === xa ? t.fsPath ?? null : null, n;
			}
		} else return t;
	}
};
const xa = qt ? 1 : void 0;
var ot = class extends Jr {
	...
	toString(e = !1) {
		return e ? ur(this, !0) : (this._formatted || (this._formatted = ur(this, !1)), this._formatted);
	}
	toJSON() {
		const e = { $mid: 1 };
		return this._fsPath && (e.fsPath = this._fsPath, e._sep = xa), this._formatted && (e.external = this._formatted), this.path && (e.path = this.path), this.scheme && (e.scheme = this.scheme), this.authority && (e.authority = this.authority), this.query && (e.query = this.query), this.fragment && (e.fragment = this.fragment), e;
	}
};
const Ra = {
	58: "%3A",
...
function ur(e, t) {
	...
	if (i && (r += i, r += ":"), (s || i === "file") && (r += Ae, r += Ae), s) {
		let u = s.indexOf("@");
		if (u !== -1) {
	...
	return l && (r += "?", r += n(l, !1, !1)), o && (r += "#", r += t ? o : ui(o, !1, !1)), r;
}
function Ma(e) {
	try {
		return decodeURIComponent(e);
	} catch {
		return e.length > 3 ? e.substr(0, 3) + Ma(e.substr(3)) : e;
	}
}
const ci = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function Xt(e) {
	return e.match(ci) ? e.replace(ci, (t) => Ma(t)) : e;
}
var Bl = class we extends U {
	constructor(t, n, r, i) {
...
var jl = class {
	...
	register(e, t) {
		return this._tokenizationSupports.set(e, t), this.handleChange([e]), yn(() => {
	...
	registerFactory(e, t) {
		...
		const n = new Wl(this, e, t);
		return this._factories.set(e, n), yn(() => {
...
(class We {
	static {
		this.Comment = new We("comment");
	}
	static {
		this.Imports = new We("imports");
	}
	static {
		this.Region = new We("region");
	}
	static fromValue(t) {
		switch (t) {
			case "comment": return We.Comment;
			case "imports": return We.Imports;
			case "region": return We.Region;
		}
		return new We(t);
	}
	constructor(t) {
...
(class Ft {
	...
	constructor(t, n) {
		if (this[ds] = "ResourceMap", t instanceof Ft) this.map = new Map(t.map), this.toKey = n ?? Ft.defaultToKey;
		else if (Xl(t)) {
			this.map = /* @__PURE__ */ new Map(), this.toKey = n ?? Ft.defaultToKey;
			for (const [r, i] of t) this.set(r, i);
		} else this.map = /* @__PURE__ */ new Map(), this.toKey = t ?? Ft.defaultToKey;
	}
	set(t, n) {
...
var Ql = class {
	constructor() {
		this[bs] = "LinkedMap", this._map = /* @__PURE__ */ new Map(), this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0;
	}
	clear() {
	...
	[(bs = Symbol.toStringTag, Symbol.iterator)]() {
		return this.entries();
	}
	trimOld(e) {
...
function ru(e, t, n, r, i) {
	return tu(e, t, n, r, i) && nu(e, t, n, r, i);
}
var iu = class {
	constructor(e, t) {
	...
	next(e) {
		...
		do {
			...
			if (r === this._prevMatchStartIndex && i === this._prevMatchLength) {
				if (i === 0) {
					Go(e, t, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
					continue;
				}
				return null;
			}
			if (this._prevMatchStartIndex = r, this._prevMatchLength = i, !this._wordSeparators || ru(this._wordSeparators, e, t, r, i)) return n;
		} while (n);
		return null;
	}
};
...
function Xr(e, t, n, r, i) {
	if (t = Ta(t), i || (i = bn.first(Pa)), n.length > i.maxLen) {
		let u = e - i.maxLen / 2;
		return u < 0 ? u = 0 : r += u, n = n.substring(u, e + i.maxLen / 2), Xr(e, t, n, r, i);
	}
...
var lu = class {
	static computeUnicodeHighlights(e, t, n) {
		const r = n ? n.startLineNumber : 1, i = n ? n.endLineNumber : e.getLineCount(), s = new Ns(t), a = s.getCandidateCodePoints();
		let l;
		a === "allNonBasicAscii" ? l = /* @__PURE__ */ new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : l = new RegExp(`${uu(Array.from(a))}`, "g");
		const o = new iu(null, l), u = [];
		...
		e: for (let p = r, v = i; p <= v; p++) {
			...
			do
				if (f = o.next(S), f) {
					...
					b > 0 && _n(S.charCodeAt(b - 1)) && b--, w + 1 < N && _n(S.charCodeAt(w - 1)) && w++;
					const y = S.substring(b, w);
					let A = Xr(b + 1, Ea, S, 0);
					A && A.endColumn <= b + 1 && (A = null);
					const _ = s.shouldHighlightNonBasicASCII(y, A ? A.word : null);
					if (_ !== 0) {
						if (_ === 3 ? g++ : _ === 2 ? m++ : _ === 1 ? d++ : uo(), u.length >= 1e3) {
							h = !0;
							break e;
						}
						u.push(new U(p, b + 1, p, w + 1));
					}
				}
			while (f);
		}
	...
	static computeUnicodeHighlightReason(e, t) {
		...
		switch (n.shouldHighlightNonBasicASCII(e, null)) {
			...
			case 3: {
				const r = e.codePointAt(0), i = n.ambiguousCharacters.getPrimaryConfusable(r), s = rr.getLocales().filter((a) => !rr.getInstance(new Set([...t.allowedLocales, a])).isAmbiguous(r));
				return {
					kind: 0,
...
function uu(e, t) {
	return `[${Bo(e.map((n) => String.fromCodePoint(n)).join(""))}]`;
}
var Ns = class {
	constructor(e) {
		this.options = e, this.allowedCodePoints = new Set(e.allowedCodePoints), this.ambiguousCharacters = rr.getInstance(new Set(e.allowedLocales));
	}
	getCandidateCodePoints() {
		if (this.options.nonBasicASCII) return "allNonBasicAscii";
		const e = /* @__PURE__ */ new Set();
		if (this.options.invisibleCharacters) for (const t of Dn.codePoints) Ss(String.fromCodePoint(t)) || e.add(t);
	...
	shouldHighlightNonBasicASCII(e, t) {
		...
		if (t) for (const s of t) {
			const a = s.codePointAt(0), l = Xo(s);
			r = r || l, !l && !this.ambiguousCharacters.isAmbiguous(a) && !Dn.isInvisibleCharacter(a) && (i = !0);
		}
		return !r && i ? 0 : this.options.invisibleCharacters && !Ss(e) && Dn.isInvisibleCharacter(n) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(n) ? 3 : 0;
	}
};
function Ss(e) {
	return e === " " || e === `
...
(class cn {
	...
	findLastMaxBy(t) {
		let n, r = !0;
		return this.iterate((i) => ((r || gr.isGreaterThan(t(i, n))) && (r = !1, n = i), !0)), n;
	}
});
var X = class de {
	static fromTo(t, n) {
	...
	delta(t) {
		return new de(this.start + t, this.endExclusive + t);
	}
	deltaStart(t) {
		return new de(this.start + t, this.endExclusive);
	}
	deltaEnd(t) {
		return new de(this.start, this.endExclusive + t);
	}
	get length() {
	...
	join(t) {
		return new de(Math.min(this.start, t.start), Math.max(this.endExclusive, t.endExclusive));
	}
	intersect(t) {
		const n = Math.max(this.start, t.start), r = Math.min(this.endExclusive, t.endExclusive);
		if (n <= r) return new de(n, r);
	}
	...
	joinRightTouching(t) {
		...
		return new de(this.start, t.endExclusive);
	}
};
function vt(e, t) {
	const n = wt(e, t);
...
function dr(e, t, n = 0, r = e.length) {
	let i = n, s = r;
	for (; i < s;) {
		const a = Math.floor((i + s) / 2);
		t(e[a]) ? s = a : i = a + 1;
...
var Ca = class Ia {
	...
	static {
		this.compareByStart = Ot((t) => t.startLineNumber, $t);
	}
	static joinMany(t) {
		if (t.length === 0) return [];
		let n = new An(t[0].slice());
		for (let r = 1; r < t.length; r++) n = n.getUnion(new An(t[r].slice()));
		return n.ranges;
	}
	static join(t) {
	...
	addMargin(t, n) {
		return new Ne(this.startLineNumber - t, this.endLineNumberExclusive + n);
	}
}, An = class gt {
	constructor(t = []) {
	...
	addRange(t) {
		if (t.length === 0) return;
		const n = dr(this._normalizedRanges, (i) => i.endLineNumberExclusive >= t.startLineNumber), r = wt(this._normalizedRanges, (i) => i.startLineNumber <= t.endLineNumberExclusive) + 1;
	...
	getUnion(t) {
		...
		return s !== null && n.push(s), new gt(n);
	}
	subtractFrom(t) {
		const n = dr(this._normalizedRanges, (a) => a.endLineNumberExclusive >= t.startLineNumber), r = wt(this._normalizedRanges, (a) => a.startLineNumber <= t.endLineNumberExclusive) + 1;
		if (n === r) return new gt([t]);
		const i = [];
		...
		return s < t.endLineNumberExclusive && i.push(new z(s, t.endLineNumberExclusive)), new gt(i);
	}
	toString() {
	...
	getWithDelta(t) {
		return new gt(this._normalizedRanges.map((n) => n.delta(t)));
	}
}, pr = class Ve {
	static {
		this.zero = new Ve(0, 0);
	}
	static betweenPositions(t, n) {
		return t.lineNumber === n.lineNumber ? new Ve(0, n.column - t.column) : new Ve(n.lineNumber - t.lineNumber, n.column - 1);
	}
	static fromPosition(t) {
		return new Ve(t.lineNumber - 1, t.column - 1);
	}
	static ofRange(t) {
		return Ve.betweenPositions(t.getStartPosition(), t.getEndPosition());
	}
	static ofText(t) {
		let n = 0, r = 0;
		for (const i of t) i === `
` ? (n++, r = 0) : r++;
	...
	add(t) {
		return t.lineCount === 0 ? new Ve(this.lineCount, this.columnCount + t.columnCount) : new Ve(this.lineCount + t.lineCount, t.columnCount);
	}
	createRange(t) {
	...
	getStringReplacement(e) {
		return new fn.deps.StringReplacement(this.getOffsetRange(e.range), e.text);
	}
	getTextReplacement(e) {
		return new fn.deps.TextReplacement(this.getRange(e.replaceRange), e.newText);
	}
	getTextEdit(e) {
		const t = e.replacements.map((n) => this.getTextReplacement(n));
		return new fn.deps.TextEdit(t);
	}
}, fn = class {
	static {
		this._deps = void 0;
...
` && (this.lineStartOffsetByLineIdx.push(t + 1), t > 0 && e.charAt(t - 1) === "\r" ? this.lineEndOffsetByLineIdx.push(t - 1) : this.lineEndOffsetByLineIdx.push(t));
	...
	getPosition(e) {
		const t = wt(this.lineStartOffsetByLineIdx, (n) => n <= e);
		return new J(t + 1, e - this.lineStartOffsetByLineIdx[t] + 1);
	}
	get textLength() {
		const e = this.lineStartOffsetByLineIdx.length - 1;
		return new fn.deps.TextLength(e, this.text.length - this.lineStartOffsetByLineIdx[e]);
	}
	getLineLength(e) {
	...
	constructor(e, t) {
		co(t >= 1), super(), this._getLineContent = e, this._lineCount = t;
	}
	getValueOfRange(e) {
...
` + this._getLineContent(e.endLineNumber).substring(0, e.endColumn - 1), t;
	...
	get length() {
		...
		return new pr(this._lineCount - 1, e.length);
	}
}, Qt = class extends _u {
	constructor(e) {
	...
	static joinReplacements(t, n) {
		...
		for (let a = 0; a < t.length; a++) {
			...
			if (s += l.text, a < t.length - 1) {
				const o = t[a + 1], u = U.fromPositions(l.range.getEndPosition(), o.range.getStartPosition()), h = n.getValueOfRange(u);
				s += h;
			}
		}
		return new Xe(U.fromPositions(r, i), s);
	}
...
`, `
`), i = Ho(n, r), s = pr.ofText(n.substring(0, i)).addToPosition(this.range.getStartPosition()), a = r.substring(i);
		return new Xe(U.fromPositions(s, this.range.getEndPosition()), a);
	}
...
`), r = this.text.replaceAll(`\r
`, `
`), i = zo(n, r), s = pr.ofText(n.substring(0, n.length - i)).addToPosition(this.range.getStartPosition()), a = r.substring(0, r.length - i);
		return new Xe(U.fromPositions(this.range.getStartPosition(), s), a);
	}
	toString() {
	...
	static inverse(t, n, r) {
		...
		let s = 1, a = 1;
		for (const o of t) {
			const u = new dt(new z(s, o.original.startLineNumber), new z(a, o.modified.startLineNumber));
			u.modified.isEmpty || i.push(u), s = o.original.endLineNumberExclusive, a = o.modified.endLineNumberExclusive;
		}
		const l = new dt(new z(s, n + 1), new z(a, r + 1));
	...
	static clip(t, n, r) {
		...
		for (const s of t) {
			...
			a && !a.isEmpty && l && !l.isEmpty && i.push(new dt(a, l));
		}
		return i;
	}
	constructor(t, n) {
	...
	flip() {
		return new dt(this.modified, this.original);
	}
	join(t) {
		return new dt(this.original.join(t.original), this.modified.join(t.modified));
	}
	toRangeMapping() {
	...
	toRangeMapping2(t, n) {
		if (As(this.original.endLineNumberExclusive, t) && As(this.modified.endLineNumberExclusive, n)) return new Oe(new U(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new U(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
		if (!this.original.isEmpty && !this.modified.isEmpty) return new Oe(U.fromPositions(new J(this.original.startLineNumber, 1), lt(new J(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), U.fromPositions(new J(this.modified.startLineNumber, 1), lt(new J(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
		if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1) return new Oe(U.fromPositions(lt(new J(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), lt(new J(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), U.fromPositions(lt(new J(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), lt(new J(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
		throw new ue();
	}
};
function lt(e, t) {
...
var jt = class hn extends _t {
	static fromRangeMappings(t) {
		return new hn(z.join(t.map((n) => z.fromRangeInclusive(n.originalRange))), z.join(t.map((n) => z.fromRangeInclusive(n.modifiedRange))), t);
	}
	constructor(t, n, r) {
		super(t, n), this.innerChanges = r;
	}
	flip() {
		return new hn(this.modified, this.original, this.innerChanges?.map((t) => t.flip()));
	}
	withInnerChangesFromLineRanges() {
		return new hn(this.original, this.modified, [this.toRangeMapping()]);
	}
}, Oe = class br {
	static fromEdit(t) {
		const n = t.getNewRanges();
		return t.replacements.map((r, i) => new br(r.range, n[i]));
	}
	...
	flip() {
		return new br(this.modifiedRange, this.originalRange);
	}
	toTextEdit(t) {
		const n = t.getValueOfRange(this.modifiedRange);
		return new Lu(this.originalRange, n);
	}
};
function ks(e, t, n, r = !1) {
	const i = [];
	for (const s of hu(e.map((a) => Nu(a, t, n)), (a, l) => a.original.intersectsOrTouches(l.original) || a.modified.intersectsOrTouches(l.modified))) {
		const a = s[0], l = s[s.length - 1];
		i.push(new jt(a.original.join(l.original), a.modified.join(l.modified), s.map((o) => o.innerChanges[0])));
	}
	return pn(() => !r && i.length > 0 && (i[0].modified.startLineNumber !== i[0].original.startLineNumber || n.length.lineCount - i[i.length - 1].modified.endLineNumberExclusive !== t.length.lineCount - i[i.length - 1].original.endLineNumberExclusive) ? !1 : sa(i, (s, a) => a.original.startLineNumber - s.original.endLineNumberExclusive === a.modified.startLineNumber - s.modified.endLineNumberExclusive && s.original.endLineNumberExclusive < a.original.startLineNumber && s.modified.endLineNumberExclusive < a.modified.startLineNumber)), i;
}
function Nu(e, t, n) {
	let r = 0, i = 0;
	return e.modifiedRange.endColumn === 1 && e.originalRange.endColumn === 1 && e.originalRange.startLineNumber + r <= e.originalRange.endLineNumber && e.modifiedRange.startLineNumber + r <= e.modifiedRange.endLineNumber && (i = -1), e.modifiedRange.startColumn - 1 >= n.getLineLength(e.modifiedRange.startLineNumber) && e.originalRange.startColumn - 1 >= t.getLineLength(e.originalRange.startLineNumber) && e.originalRange.startLineNumber <= e.originalRange.endLineNumber + i && e.modifiedRange.startLineNumber <= e.modifiedRange.endLineNumber + i && (r = 1), new jt(new z(e.originalRange.startLineNumber + r, e.originalRange.endLineNumber + 1 + i), new z(e.modifiedRange.startLineNumber + r, e.modifiedRange.endLineNumber + 1 + i), [e]);
}
const Su = 3;
var Au = class {
	computeDiff(e, t, n) {
		...
		for (const a of r.changes) {
			...
			let u = new jt(l, o, a.charChanges?.map((h) => new Oe(new U(h.originalStartLineNumber, h.originalStartColumn, h.originalEndLineNumber, h.originalEndColumn), new U(h.modifiedStartLineNumber, h.modifiedStartColumn, h.modifiedEndLineNumber, h.modifiedEndColumn))));
			s && (s.modified.endLineNumberExclusive === u.modified.startLineNumber || s.original.endLineNumberExclusive === u.original.startLineNumber) && (u = new jt(s.original.join(u.original), s.modified.join(u.modified), s.innerChanges && u.innerChanges ? s.innerChanges.concat(u.innerChanges) : void 0), i.pop()), i.push(u), s = u;
		}
		return pn(() => sa(i, (a, l) => l.original.startLineNumber - a.original.endLineNumberExclusive === l.modified.startLineNumber - a.modified.endLineNumberExclusive && a.original.endLineNumberExclusive < l.original.startLineNumber && a.modified.endLineNumberExclusive < l.modified.startLineNumber)), new un(i, [], r.quitEarly);
	}
};
function Fa(e, t, n, r) {
	return new wa(e, t, n).ComputeDiff(r);
}
var xs = class {
	constructor(e) {
		const t = [], n = [];
		for (let r = 0, i = e.length; r < i; r++) t[r] = yr(e[r], 1), n[r] = vr(e[r], 1);
...
function xu(e) {
	...
	for (let r = 1, i = e.length; r < i; r++) {
		...
		Math.min(a, l) < Su ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s);
	}
	return t;
}
var jn = class Da {
	...
	static createFromDiffResult(t, n, r, i, s, a, l) {
		...
		if (n.originalLength === 0 ? (o = r.getStartLineNumber(n.originalStart) - 1, u = 0) : (o = r.getStartLineNumber(n.originalStart), u = r.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (h = i.getStartLineNumber(n.modifiedStart) - 1, f = 0) : (h = i.getStartLineNumber(n.modifiedStart), f = i.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && s()) {
			...
			if (m.getElements().length > 0 && d.getElements().length > 0) {
				let p = Fa(m, d, s, !0).changes;
				l && (p = xu(p)), g = [];
				for (let v = 0, S = p.length; v < S; v++) g.push(mn.createFromDiffChange(p[v], m, d));
			}
		}
		return new Da(o, u, h, f, g);
	}
}, Ru = class {
	constructor(e, t, n) {
		this.shouldComputeCharChanges = n.shouldComputeCharChanges, this.shouldPostProcessCharChanges = n.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = n.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = n.shouldMakePrettyDiff, this.originalLines = e, this.modifiedLines = t, this.original = new xs(e), this.modified = new xs(t), this.continueLineDiff = Rs(n.maxComputationTime), this.continueCharDiff = Rs(n.maxComputationTime === 0 ? 0 : Math.min(n.maxComputationTime, 5e3));
	}
	computeDiff() {
		...
		const e = Fa(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), t = e.changes, n = e.quitEarly;
		if (this.shouldIgnoreTrimWhitespace) {
			const a = [];
			for (let l = 0, o = t.length; l < o; l++) a.push(jn.createFromDiffResult(this.shouldIgnoreTrimWhitespace, t[l], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
			return {
				quitEarly: n,
				changes: a
			};
		...
		for (let a = -1, l = t.length; a < l; a++) {
			...
			o && (r.push(jn.createFromDiffResult(this.shouldIgnoreTrimWhitespace, o, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), i += o.originalLength, s += o.modifiedLength);
		}
		return {
			quitEarly: n,
			changes: r
	...
	_pushTrimWhitespaceCharChange(e, t, n, r, i, s, a) {
		...
		let l;
		this.shouldComputeCharChanges && (l = [new mn(t, n, t, r, i, s, i, a)]), e.push(new jn(t, t, i, i, l));
	}
	_mergeTrimWhitespaceCharChange(e, t, n, r, i, s, a) {
		const l = e.length;
		if (l === 0) return !1;
		const o = e[l - 1];
		return o.originalEndLineNumber === 0 || o.modifiedEndLineNumber === 0 ? !1 : o.originalEndLineNumber === t && o.modifiedEndLineNumber === i ? (this.shouldComputeCharChanges && o.charChanges && o.charChanges.push(new mn(t, n, t, r, i, s, i, a)), !0) : o.originalEndLineNumber + 1 === t && o.modifiedEndLineNumber + 1 === i ? (o.originalEndLineNumber = t, o.modifiedEndLineNumber = i, this.shouldComputeCharChanges && o.charChanges && o.charChanges.push(new mn(t, n, t, r, i, s, i, a)), !0) : !1;
	}
};
function yr(e, t) {
	const n = jo(e);
...
var bt = class wr {
	static trivial(t, n) {
		return new wr([new ge(X.ofLength(t.length), X.ofLength(n.length))], !1);
	}
	static trivialTimedOut(t, n) {
		return new wr([new ge(X.ofLength(t.length), X.ofLength(n.length))], !0);
	}
	constructor(t, n) {
	...
	static invert(t, n) {
		const r = [];
		return mu(t, (i, s) => {
			r.push(De.fromOffsetPairs(i ? i.getEndExclusives() : Ye.zero, s ? s.getStarts() : new Ye(n, (i ? i.seq2Range.endExclusive - i.seq1Range.endExclusive : 0) + n)));
		}), r;
	}
	static fromOffsetPairs(t, n) {
		return new De(new X(t.offset1, n.offset1), new X(t.offset2, n.offset2));
	}
	static assertSorted(t) {
		let n;
		for (const r of t) {
	...
	swap() {
		return new De(this.seq2Range, this.seq1Range);
	}
	toString() {
		return `${this.seq1Range} <-> ${this.seq2Range}`;
	}
	join(t) {
		return new De(this.seq1Range.join(t.seq1Range), this.seq2Range.join(t.seq2Range));
	}
	delta(t) {
		return t === 0 ? this : new De(this.seq1Range.delta(t), this.seq2Range.delta(t));
	}
	deltaStart(t) {
		return t === 0 ? this : new De(this.seq1Range.deltaStart(t), this.seq2Range.deltaStart(t));
	}
	deltaEnd(t) {
		return t === 0 ? this : new De(this.seq1Range.deltaEnd(t), this.seq2Range.deltaEnd(t));
	}
	intersect(t) {
	...
	static {
		this.zero = new gn(0, 0);
	}
	static {
		this.max = new gn(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER);
	}
	constructor(t, n) {
...
`);
	...
	compute(e, t, n = Qr.instance, r) {
		if (e.length === 0 || t.length === 0) return bt.trivial(e, t);
		const i = new Wn(e.length, t.length), s = new Wn(e.length, t.length), a = new Wn(e.length, t.length);
		for (let m = 0; m < e.length; m++) for (let d = 0; d < t.length; d++) {
			if (!n.isValid()) return bt.trivialTimedOut(e, t);
		...
		return h(-1, -1), l.reverse(), new bt(l, !1);
	}
}, $a = class {
	compute(e, t, n = Qr.instance) {
		if (e.length === 0 || t.length === 0) return bt.trivial(e, t);
		const r = e, i = t;
		function s(d, p) {
		...
		l.set(0, s(0, 0));
		const o = new Pu();
		o.set(0, l.get(0) === 0 ? null : new Es(null, 0, 0, l.get(0)));
		let u = 0;
		e: for (;;) {
			if (a++, !n.isValid()) return bt.trivialTimedOut(r, i);
			...
			for (u = d; u <= p; u += 2) {
				...
				if (o.set(u, w !== N ? new Es(y, N, b, w - N) : y), l.get(u) === r.length && l.get(u) - u === i.length) break e;
			}
		}
		let h = o.get(u);
		const f = [];
	...
	getBoundaryScore(e) {
		...
		if (t === 8) return 150;
		let r = 0;
		return t !== n && (r += 10, t === 0 && n === 1 && (r += 1)), r += Ps(t), r += Ps(n), r;
	}
	translateOffset(e, t = "right") {
		const n = wt(this.firstElementOffsetByLineIdx, (i) => i <= e), r = e - this.firstElementOffsetByLineIdx[n];
	...
	findWordContaining(e) {
		if (e < 0 || e >= this.elements.length || !ut(this.elements[e])) return;
		let t = e;
		for (; t > 0 && ut(this.elements[t - 1]);) t--;
		let n = e;
		for (; n < this.elements.length && ut(this.elements[n]);) n++;
		return new X(t, n);
	}
	findSubWordContaining(e) {
		if (e < 0 || e >= this.elements.length || !ut(this.elements[e])) return;
		let t = e;
		for (; t > 0 && ut(this.elements[t - 1]) && !Ts(this.elements[t]);) t--;
		let n = e;
		for (; n < this.elements.length && ut(this.elements[n]) && !Ts(this.elements[n]);) n++;
		return new X(t, n);
	}
	countLinesIn(e) {
	...
	extendToFullLines(e) {
		return new X(vt(this.firstElementOffsetByLineIdx, (t) => t <= e.start) ?? 0, bu(this.firstElementOffsetByLineIdx, (t) => e.endExclusive <= t) ?? this.elements.length);
	}
};
function ut(e) {
...
function Cs(e) {
	return e === 10 ? 8 : e === 13 ? 7 : _r(e) ? 6 : e >= 97 && e <= 122 ? 0 : e >= 65 && e <= 90 ? 1 : e >= 48 && e <= 57 ? 2 : e === -1 ? 3 : e === 44 || e === 59 ? 5 : 4;
}
function Iu(e, t, n, r, i, s) {
	let { moves: a, excludedChanges: l } = Vu(e, t, n, s);
	if (!s.isValid()) return [];
	const o = Du(e.filter((u) => !l.has(u)), r, i, t, n, s);
	return du(a, o), a = Ou(a), a = a.filter((u) => {
		const h = u.original.toOffsetRange().slice(t).map((f) => f.trim());
		return h.join(`
`).length >= 15 && Fu(h, (f) => f.length >= 2) >= 2;
	}), a = $u(e, a), a;
}
function Fu(e, t) {
	let n = 0;
...
function Vu(e, t, n, r) {
	const i = [], s = e.filter((o) => o.modified.isEmpty && o.original.length >= 3).map((o) => new Ms(o.original, t, o)), a = new Set(e.filter((o) => o.original.isEmpty && o.modified.length >= 3).map((o) => new Ms(o.modified, n, o))), l = /* @__PURE__ */ new Set();
	for (const o of s) {
		let u = -1, h;
		for (const f of a) {
		...
		if (u > .9 && h && (a.delete(h), i.push(new _t(o.range, h.range)), l.add(o.source), l.add(h.source)), !r.isValid()) return {
			moves: i,
			excludedChanges: l
		};
	}
...
function Du(e, t, n, r, i, s) {
	...
	const o = [];
	e.sort(Ot((g) => g.modified.startLineNumber, $t));
	for (const g of e) {
		let m = [];
	...
	o.sort(pu(Ot((g) => g.modifiedLineRange.length, $t)));
	const u = new An(), h = new An();
	for (const g of o) {
		...
		for (const S of v.ranges) {
			...
			a.push(new _t(b, N)), u.addRange(N), h.addRange(b);
		}
	}
	a.sort(Ot((g) => g.original.startLineNumber, $t));
	const f = new Ca(e);
	for (let g = 0; g < a.length; g++) {
		const m = a[g], d = f.findLastMonotonous((A) => A.original.startLineNumber <= m.original.startLineNumber), p = vt(e, (A) => A.modified.startLineNumber <= m.modified.startLineNumber), v = Math.max(m.original.startLineNumber - d.original.startLineNumber, m.modified.startLineNumber - p.modified.startLineNumber), S = f.findLastMonotonous((A) => A.original.startLineNumber < m.original.endLineNumberExclusive), N = vt(e, (A) => A.modified.startLineNumber < m.modified.endLineNumberExclusive), b = Math.max(S.original.endLineNumberExclusive - m.original.endLineNumberExclusive, N.modified.endLineNumberExclusive - m.modified.endLineNumberExclusive);
		let w;
		for (w = 0; w < v; w++) {
			const A = m.original.startLineNumber - w - 1, _ = m.modified.startLineNumber - w - 1;
			if (A > r.length || _ > i.length || u.contains(_) || h.contains(A) || !Is(r[A - 1], i[_ - 1], s)) break;
		}
...
function Is(e, t, n) {
	...
	const r = new $a().compute(new kn([e], new U(1, 1, 1, e.length), !1), new kn([t], new U(1, 1, 1, t.length), !1), n);
	let i = 0;
	...
	function a(o) {
		let u = 0;
		for (let h = 0; h < e.length; h++) _r(o.charCodeAt(h)) || u++;
		return u;
	}
...
function Ou(e) {
	...
	e.sort(Ot((n) => n.original.startLineNumber, $t));
	const t = [e[0]];
...
function $u(e, t) {
	const n = new Ca(e);
	return t = t.filter((r) => (n.findLastMonotonous((i) => i.original.startLineNumber < r.original.endLineNumberExclusive) || new _t(new z(1, 1), new z(1, 1))) !== vt(e, (i) => i.modified.startLineNumber < r.modified.endLineNumberExclusive)), t;
}
function Fs(e, t, n) {
	let r = n;
	return r = Vs(e, t, r), r = Vs(e, t, r), r = Bu(e, t, r), r;
}
function Vs(e, t, n) {
...
function Bu(e, t, n) {
	...
	for (let r = 0; r < n.length; r++) {
		...
		s.seq1Range.isEmpty ? n[r] = Ds(s, e, t, l, o) : s.seq2Range.isEmpty && (n[r] = Ds(s.swap(), t, e, o, l).swap());
	}
	return n;
}
...
function Wu(e, t, n) {
	...
	return gu(r, (o, u, h) => {
		...
		const v = ge.fromOffsetPairs(o ? o.getEndExclusives() : Ye.zero, h ? h.getStarts() : Ye.max), S = f.intersect(v);
...
var $s = class {
	...
	getBoundaryScore(e) {
		return 1e3 - ((e === 0 ? 0 : Bs(this.lines[e - 1])) + (e === this.lines.length ? 0 : Bs(this.lines[e])));
	}
	getText(e) {
...
var Hu = class {
	constructor() {
		this.dynamicProgrammingDiffing = new Eu(), this.myersDiffingAlgorithm = new $a();
	}
	computeDiff(e, t, n) {
		if (e.length <= 1 && fu(e, t, (w, y) => w === y)) return new un([], [], !1);
		if (e.length === 1 && e[0].length === 0 || t.length === 1 && t[0].length === 0) return new un([new jt(new z(1, e.length + 1), new z(1, t.length + 1), [new Oe(new U(1, 1, e.length, e[e.length - 1].length + 1), new U(1, 1, t.length, t[t.length - 1].length + 1))])], [], !1);
		const r = n.maxComputationTimeMs === 0 ? Qr.instance : new Mu(n.maxComputationTimeMs), i = !n.ignoreTrimWhitespace, s = /* @__PURE__ */ new Map();
		function a(w) {
			let y = s.get(w);
			return y === void 0 && (y = s.size, s.set(w, y)), y;
		}
		const l = e.map((w) => a(w.trim())), o = t.map((w) => a(w.trim())), u = new $s(l, e), h = new $s(o, t), f = u.length + h.length < 1700 ? this.dynamicProgrammingDiffing.compute(u, h, r, (w, y) => e[w] === t[y] ? t[y].length === 0 ? .1 : 1 + Math.log(1 + t[y].length) : .99) : this.myersDiffingAlgorithm.compute(u, h, r);
		let g = f.diffs, m = f.hitTimeout;
		g = Fs(u, h, g), g = ju(u, h, g);
		const d = [], p = (w) => {
		...
		let v = 0, S = 0;
		for (const w of g) {
			pn(() => w.seq1Range.start - v === w.seq2Range.start - S), p(w.seq1Range.start - v), v = w.seq1Range.endExclusive, S = w.seq2Range.endExclusive;
			const y = this.refineDiff(e, t, w, r, i, n);
			y.hitTimeout && (m = !0);
			for (const A of y.mappings) d.push(A);
		}
		p(e.length - v);
		const N = ks(d, new Qt(e), new Qt(t));
		let b = [];
		return n.computeMoves && (b = this.computeMoves(N, e, t, l, o, r, i, n)), pn(() => {
			function w(A, _) {
	...
	computeMoves(e, t, n, r, i, s, a, l) {
		return Iu(e, t, n, r, i, s).map((o) => new cu(o, ks(this.refineDiff(t, n, new ge(o.original.toOffsetRange(), o.modified.toOffsetRange()), s, a, l).mappings, new Qt(t), new Qt(n), !0)));
	}
	refineDiff(e, t, n, r, i, s) {
		const a = zu(n).toRangeMapping2(e, t), l = new kn(e, a.originalRange, i), o = new kn(t, a.modifiedRange, i), u = l.length + o.length < 500 ? this.dynamicProgrammingDiffing.compute(l, o, r) : this.myersDiffingAlgorithm.compute(l, o, r);
		let h = u.diffs;
		return h = Fs(l, o, h), h = Os(l, o, h, (f, g) => f.findWordContaining(g)), s.extendToSubwords && (h = Os(l, o, h, (f, g) => f.findSubWordContaining(g), !0)), h = Uu(l, o, h), h = Wu(l, o, h), {
			mappings: h.map((f) => new Oe(l.translateRange(f.seq1Range), o.translateRange(f.seq2Range))),
			hitTimeout: u.hitTimeout
		};
	}
};
function zu(e) {
	return new _t(new z(e.seq1Range.start + 1, e.seq1Range.endExclusive + 1), new z(e.seq2Range.start + 1, e.seq2Range.endExclusive + 1));
}
const Us = {
	getLegacy: () => new Au(),
	getDefault: () => new Hu()
...
var k = class {
	constructor(e, t, n, r = 1) {
		this._rgbaBrand = void 0, this.r = Math.min(255, Math.max(0, e)) | 0, this.g = Math.min(255, Math.max(0, t)) | 0, this.b = Math.min(255, Math.max(0, n)) | 0, this.a = ze(Math.max(Math.min(1, r), 0), 3);
	}
	static equals(e, t) {
	...
	constructor(t, n, r, i) {
		this._hslaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = ze(Math.max(Math.min(1, n), 0), 3), this.l = ze(Math.max(Math.min(1, r), 0), 3), this.a = ze(Math.max(Math.min(1, i), 0), 3);
	}
	static equals(t, n) {
	...
	static toRGBA(t) {
		...
		if (r === 0) a = l = o = i;
			...
			a = Vt._hue2rgb(h, u, n + 1 / 3), l = Vt._hue2rgb(h, u, n), o = Vt._hue2rgb(h, u, n - 1 / 3);
		}
		return new k(Math.round(a * 255), Math.round(l * 255), Math.round(o * 255), s);
	}
}, Zt = class Ba {
	constructor(t, n, r, i) {
		this._hsvaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = ze(Math.max(Math.min(1, n), 0), 3), this.v = ze(Math.max(Math.min(1, r), 0), 3), this.a = ze(Math.max(Math.min(1, i), 0), 3);
	}
	static equals(t, n) {
	...
	static fromRGBA(t) {
		...
		let o;
		return a === 0 ? o = 0 : s === n ? o = ((r - i) / a % 6 + 6) % 6 : s === r ? o = (i - n) / a + 2 : o = (n - r) / a + 4, new Ba(Math.round(o * 60), l, s, t.a);
	}
	static toRGBA(t) {
	...
	get hsla() {
		return this._hsla ? this._hsla : Qe.fromRGBA(this.rgba);
	}
	get hsva() {
		return this._hsva ? this._hsva : Zt.fromRGBA(this.rgba);
	}
	constructor(t) {
		if (t) if (t instanceof k) this.rgba = t;
		else if (t instanceof Qe) this._hsla = t, this.rgba = Qe.toRGBA(t);
		else if (t instanceof Zt) this._hsva = t, this.rgba = Zt.toRGBA(t);
		else throw new Error("Invalid color ctor argument");
		else throw new Error("Color needs a value");
	}
	equals(t) {
		return !!t && k.equals(this.rgba, t.rgba) && Qe.equals(this.hsla, t.hsla) && Zt.equals(this.hsva, t.hsva);
	}
	getRelativeLuminance() {
		...
		return ze(.2126 * t + .7152 * n + .0722 * r, 4);
	}
	...
	lighten(t) {
		return new ne(new Qe(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * t, this.hsla.a));
	}
	darken(t) {
		return new ne(new Qe(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * t, this.hsla.a));
	}
...
function Gu(e, t) {
	...
	if (n) return {
		range: e,
		color: Zr(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)
	};
}
function qs(e, t, n) {
	if (!e || t.length !== 1) return;
	const r = Ua(t[0].values());
	return {
		range: e,
		color: Zr(r[0], r[1], r[2], n ? r[3] : 1)
	};
}
function js(e, t, n) {
	if (!e || t.length !== 1) return;
	const r = Ua(t[0].values()), i = new xn(new Qe(r[0], r[1] / 100, r[2] / 100, n ? r[3] : 1));
	return {
		range: e,
		color: Zr(i.rgba.r, i.rgba.g, i.rgba.b, i.rgba.a)
	};
}
function Et(e, t) {
...
function Ju(e) {
	const t = [], n = Et(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|^(#)([A-Fa-f0-9]{3})\b|^(#)([A-Fa-f0-9]{4})\b|^(#)([A-Fa-f0-9]{6})\b|^(#)([A-Fa-f0-9]{8})\b|(?<=['"\s])(#)([A-Fa-f0-9]{3})\b|(?<=['"\s])(#)([A-Fa-f0-9]{4})\b|(?<=['"\s])(#)([A-Fa-f0-9]{6})\b|(?<=['"\s])(#)([A-Fa-f0-9]{8})\b/gm);
	if (n.length > 0) for (const r of n) {
		const i = r.filter((o) => o !== void 0), s = i[1], a = i[2];
		if (!a) continue;
		let l;
		s === "rgb" ? l = qs(Mt(e, r), Et(a, /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*\)$/gm), !1) : s === "rgba" ? l = qs(Mt(e, r), Et(a, /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(0[.][0-9]+|[.][0-9]+|[01][.]|[01])\s*\)$/gm), !0) : s === "hsl" ? l = js(Mt(e, r), Et(a, /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*\)$/gm), !1) : s === "hsla" ? l = js(Mt(e, r), Et(a, /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(0[.][0-9]+|[.][0-9]+|[01][.]0*|[01])\s*\)$/gm), !0) : s === "#" && (l = Gu(Mt(e, r), s + a)), l && t.push(l);
	}
	return t;
}
function Xu(e) {
	return !e || typeof e.getValue != "function" || typeof e.positionAt != "function" ? [] : Ju(e);
}
const Qu = /^-+|-+$/g, Ws = 100, Zu = 5;
function Yu(e, t) {
	let n = [];
...
function ec(e, t) {
	...
	if (Uo(s)) return n;
	for (let a = 1; a <= r; a += Ws - Zu) {
		const l = Math.min(a + Ws - 1, r), o = [];
...
(class _e {
	constructor(t, n) {
		this._onReturn = n, this._producerConsumer = new ic(), this._iterator = {
...
var sc = class {
	...
	$acceptNewModel(e) {
		this._models[e.url] = new uc(Jr.parse(e.url), e.lines, e.EOL, e.versionId);
	}
	...
	getWordAtPosition(e, t) {
		const n = Xr(e.column, Ta(t), this._lines[e.lineNumber - 1], 0);
	...
	constructor(t = null) {
		this._foreignModule = t, this._requestHandlerBrand = void 0, this._workerTextModelSyncServer = new lc();
	}
	dispose() {}
	async $ping() {
		return "pong";
	...
	async $computeUnicodeHighlights(t, n, r) {
		...
		return i ? lu.computeUnicodeHighlights(i, n, r) : {
			ranges: [],
			hasMore: !1,
	...
	async $computeDiff(t, n, r, i) {
		...
		return !s || !a ? null : dn.computeDiff(s, a, r, i);
	}
	static computeDiff(t, n, r, i) {
		const s = i === "advanced" ? Us.getDefault() : Us.getLegacy(), a = t.getLinesContent(), l = n.getLinesContent(), o = s.computeDiff(a, l, r), u = o.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
		function h(f) {
			return f.map((g) => [
	...
	async $computeMoreMinimalEdits(t, n, r) {
		...
		const s = [];
		let a;
		n = n.slice(0).sort((o, u) => o.range && u.range ? U.compareRangesUsingStarts(o.range, u.range) : (o.range ? 0 : 1) - (u.range ? 0 : 1));
		let l = 0;
		for (let o = 1; o < n.length; o++) U.getEndPosition(n[l].range).equals(U.getStartPosition(n[o].range)) ? (n[l].range = U.fromPositions(U.getStartPosition(n[l].range), U.getEndPosition(n[o].range)), n[l].text += n[o].text) : (l++, n[l] = n[o]);
		n.length = l + 1;
		for (let { range: o, text: u, eol: h } of n) {
			if (typeof h == "number" && (a = h), U.isEmpty(o) && !u) continue;
			const f = i.getValueInRange(o);
			if (u = u.replace(/\r\n|\n|\r/g, i.eol), f === u) continue;
			if (Math.max(u.length, f.length) > dn._diffLimit) {
				s.push({
					range: o,
					text: u
				});
			...
			const g = ll(f, u, r), m = i.offsetAt(U.lift(o).getStartPosition());
			for (const d of g) {
	...
	async $textualSuggest(t, n, r, i) {
		const s = new la(), a = new RegExp(r, i), l = /* @__PURE__ */ new Set();
		e: for (const o of t) {
			const u = this._getModel(o);
			if (u) {
				for (const h of u.words(a)) if (!(h === n || !isNaN(Number(h))) && (l.add(h), l.size > dn._suggestionsLimit)) break e;
			}
		}
		return {
			words: Array.from(l),
	...
	async $navigateValueSet(t, n, r, i, s) {
		...
		return pl.INSTANCE.navigateValueSet(n, o, u, h, r);
	}
	$fmr(t, n) {
...
typeof importScripts == "function" && (globalThis.monaco = Gl());
var fc = class Nr {
	static {
		this.CHANNEL_NAME = "editorWorkerHost";
	}
	static getChannel(t) {
		return t.getChannel(Nr.CHANNEL_NAME);
	}
	static setChannel(t, n) {
		t.setChannel(Nr.CHANNEL_NAME, n);
	}
};
function hc(e) {
	let t;
	const n = il((r) => {
		const i = fc.getChannel(r);
		return t = e({
...
function Yr(e, t = !1) {
	...
	function d() {
		...
		else for (r++; r < e.length && ct(e.charCodeAt(r));) r++;
		if (r < e.length && e.charCodeAt(r) === 46) if (r++, r < e.length && ct(e.charCodeAt(r))) for (r++; r < e.length && ct(e.charCodeAt(r));) r++;
		else return f = 3, e.substring(b, r);
		let w = r;
		if (r < e.length && (e.charCodeAt(r) === 69 || e.charCodeAt(r) === 101)) if (r++, (r < e.length && e.charCodeAt(r) === 43 || e.charCodeAt(r) === 45) && r++, r < e.length && ct(e.charCodeAt(r))) {
			for (r++; r < e.length && ct(e.charCodeAt(r));) r++;
			w = r;
		} else f = 3;
...
`;
	...
	function v() {
		...
		if (Tt(b)) return r++, i += String.fromCharCode(b), b === 13 && e.charCodeAt(r) === 10 && (r++, i += `
`), l++, u = r, a = 14;
		switch (b) {
			...
			case 47:
				...
				if (e.charCodeAt(r + 1) === 47) {
					for (r += 2; r < n && !Tt(e.charCodeAt(r));) r++;
				...
				if (e.charCodeAt(r + 1) === 42) {
					...
					for (; r < y;) {
						...
						r++, Tt(_) && (_ === 13 && e.charCodeAt(r) === 10 && r++, l++, u = r);
					}
					return A || (r++, f = 1), i = e.substring(w, r), a = 13;
				}
				return i += String.fromCharCode(b), r++, a = 16;
			case 45: if (i += String.fromCharCode(b), r++, r === n || !ct(e.charCodeAt(r))) return a = 16;
			case 48:
			case 49:
			case 50:
			case 51:
...
const Le = new Array(20).fill(0).map((e, t) => " ".repeat(t)), ft = 200, Gs = {
	" ": {
		"\n": new Array(ft).fill(0).map((e, t) => `
` + " ".repeat(t)),
		"\r": new Array(ft).fill(0).map((e, t) => "\r" + " ".repeat(t)),
...
function pc(e, t, n) {
	let r, i, s, a, l;
	if (t) {
		for (a = t.offset, l = a + t.length, s = a; s > 0 && !Js(e, s - 1);) s--;
		let y = l;
		for (; y < e.length && !Js(e, y);) y++;
		i = e.substring(s, y), r = bc(i, n);
	} else i = e, r = 0, s = 0, a = 0, l = e.length;
	const o = yc(n, e), u = dc.includes(o);
	let h = 0, f = 0, g;
	n.insertSpaces ? g = Le[n.tabSize || 4] ?? ht(Le[1], n.tabSize || 4) : g = "	";
	const m = g === "	" ? "	" : " ";
	let d = Yr(i, !1), p = !1;
	function v() {
		if (h > 1) return ht(o, h) + ht(g, r + f);
		const y = g.length * (r + f);
		return !u || y > Gs[m][o].length ? o + ht(g, r + f) : y <= 0 ? o : Gs[m][o][y];
	}
	function S() {
		let y = d.scan();
	...
	let w = S();
	if (n.keepLines && h > 0 && b(ht(o, h), 0, 0), w !== 17) {
		let y = d.getTokenOffset() + s;
		b(g.length * r < 20 && n.insertSpaces ? Le[g.length * r] : ht(g, r), s, y);
	}
	for (; w !== 17;) {
		let y = d.getTokenOffset() + d.getTokenLength() + s, A = S(), _ = "", T = !1;
		for (; h === 0 && (A === 12 || A === 13);) {
			let D = d.getTokenOffset() + s;
			b(Le[1], y, D), y = d.getTokenOffset() + d.getTokenLength() + s, T = A === 12, _ = T ? v() : "", A = S();
		}
		if (A === 2) w !== 1 && f--, n.keepLines && h > 0 || !n.keepLines && w !== 1 ? _ = v() : n.keepLines && (_ = Le[1]);
		else if (A === 4) w !== 3 && f--, n.keepLines && h > 0 || !n.keepLines && w !== 3 ? _ = v() : n.keepLines && (_ = Le[1]);
		else {
			switch (w) {
				case 3:
				case 1:
					f++, n.keepLines && h > 0 || !n.keepLines ? _ = v() : _ = Le[1];
					break;
				case 5:
					n.keepLines && h > 0 || !n.keepLines ? _ = v() : _ = Le[1];
					break;
				case 12:
					_ = v();
					break;
				...
				case 2:
				case 4:
					n.keepLines && h > 0 ? _ = v() : (A === 12 || A === 13) && !T ? _ = Le[1] : A !== 5 && A !== 17 && (p = !0);
					break;
				case 16:
					p = !0;
					break;
...
function Sr(e) {
	switch (e.type) {
		case "array": return e.children.map(Sr);
		case "object":
			const t = Object.create(null);
			for (let n of e.children) {
				const r = n.children[1];
				r && (t[n.children[0].value] = Sr(r));
			}
			return t;
		case "null":
		case "string":
...
(function(e) {
	function t(r, i) {
		return r === Number.MAX_VALUE && (r = En.MAX_VALUE), i === Number.MAX_VALUE && (i = En.MAX_VALUE), {
			line: r,
			character: i
		};
	}
...
(function(e) {
	...
	function n(r) {
		const i = r;
		return x.objectLiteral(i) && j.is(i.range) && kr.is(i.color);
	}
	e.is = n;
})(n1 || (n1 = {}));
var r1;
(function(e) {
	...
	function n(r) {
		const i = r;
		return x.objectLiteral(i) && x.string(i.label) && (x.undefined(i.textEdit) || Pe.is(i)) && (x.undefined(i.additionalTextEdits) || x.typedArray(i.additionalTextEdits, Pe.is));
	}
	e.is = n;
})(r1 || (r1 = {}));
var Bt;
...
(function(e) {
	...
	function n(r) {
		let i = r;
		return x.defined(i) && Lt.is(i.location) && x.string(i.message);
	}
	e.is = n;
})(xr || (xr = {}));
var ye;
...
(function(e) {
	...
	function n(r) {
		var i;
		let s = r;
		return x.defined(s) && j.is(s.range) && x.string(s.message) && (x.number(s.severity) || x.undefined(s.severity)) && (x.integer(s.code) || x.string(s.code) || x.undefined(s.code)) && (x.undefined(s.codeDescription) || x.string((i = s.codeDescription) === null || i === void 0 ? void 0 : i.href)) && (x.string(s.source) || x.undefined(s.source)) && (x.undefined(s.relatedInformation) || x.typedArray(s.relatedInformation, xr.is));
	}
	e.is = n;
})(Be || (Be = {}));
var Nt;
...
(function(e) {
	...
	function i(s) {
		const a = s;
		return Pe.is(a) && (Rr.is(a.annotationId) || St.is(a.annotationId));
	}
	e.is = i;
})(o1 || (o1 = {}));
var Mr;
(function(e) {
	...
	function n(r) {
		let i = r;
		return x.defined(i) && Ir.is(i.textDocument) && Array.isArray(i.edits);
	}
	e.is = n;
})(Mr || (Mr = {}));
var Er;
(function(e) {
	...
	function n(r) {
		let i = r;
		return i && i.kind === "create" && x.string(i.uri) && (i.options === void 0 || (i.options.overwrite === void 0 || x.boolean(i.options.overwrite)) && (i.options.ignoreIfExists === void 0 || x.boolean(i.options.ignoreIfExists))) && (i.annotationId === void 0 || St.is(i.annotationId));
	}
	e.is = n;
})(Er || (Er = {}));
var Tr;
(function(e) {
	...
	function n(r) {
		let i = r;
		return i && i.kind === "rename" && x.string(i.oldUri) && x.string(i.newUri) && (i.options === void 0 || (i.options.overwrite === void 0 || x.boolean(i.options.overwrite)) && (i.options.ignoreIfExists === void 0 || x.boolean(i.options.ignoreIfExists))) && (i.annotationId === void 0 || St.is(i.annotationId));
	}
	e.is = n;
})(Tr || (Tr = {}));
var Pr;
(function(e) {
	...
	function n(r) {
		let i = r;
		return i && i.kind === "delete" && x.string(i.uri) && (i.options === void 0 || (i.options.recursive === void 0 || x.boolean(i.options.recursive)) && (i.options.ignoreIfNotExists === void 0 || x.boolean(i.options.ignoreIfNotExists))) && (i.annotationId === void 0 || St.is(i.annotationId));
	}
	e.is = n;
})(Pr || (Pr = {}));
var Cr;
(function(e) {
	function t(n) {
		let r = n;
		return r && (r.changes !== void 0 || r.documentChanges !== void 0) && (r.documentChanges === void 0 || r.documentChanges.every((i) => x.string(i.kind) ? Er.is(i) || Tr.is(i) || Pr.is(i) : Mr.is(i)));
	}
	e.is = t;
})(Cr || (Cr = {}));
var l1;
...
(function(e) {
	function t(n) {
		const r = n;
		return x.objectLiteral(n) && nt.is(r.kind) && x.string(r.value);
	}
	e.is = t;
})(Ht || (Ht = {}));
var be;
...
(function(e) {
	function t(n) {
		let r = n;
		return !!r && x.objectLiteral(r) && (Ht.is(r.contents) || Tn.is(r.contents) || x.typedArray(r.contents, Tn.is)) && (n.range === void 0 || j.is(n.range));
	}
	e.is = t;
})(p1 || (p1 = {}));
var b1;
...
(function(e) {
	...
	function n(r) {
		let i = r;
		return x.defined(i) && x.typedArray(i.diagnostics, Be.is) && (i.only === void 0 || x.typedArray(i.only, x.string)) && (i.triggerKind === void 0 || i.triggerKind === Pn.Invoked || i.triggerKind === Pn.Automatic);
	}
	e.is = n;
})(k1 || (k1 = {}));
var x1;
(function(e) {
	function t(r, i, s) {
		let a = { title: r }, l = !0;
		return typeof i == "string" ? (l = !1, a.kind = i) : Nt.is(i) ? a.command = i : a.edit = i, l && s !== void 0 && (a.kind = s), a;
	}
	e.create = t;
	function n(r) {
		let i = r;
		return i && x.string(i.title) && (i.diagnostics === void 0 || x.typedArray(i.diagnostics, Be.is)) && (i.kind === void 0 || x.string(i.kind)) && (i.edit !== void 0 || i.command !== void 0) && (i.command === void 0 || Nt.is(i.command)) && (i.isPreferred === void 0 || x.boolean(i.isPreferred)) && (i.edit === void 0 || Cr.is(i.edit));
	}
	e.is = n;
})(x1 || (x1 = {}));
var R1;
(function(e) {
	...
	function n(r) {
		let i = r;
		return x.defined(i) && j.is(i.range) && (x.undefined(i.command) || Nt.is(i.command));
	}
	e.is = n;
})(R1 || (R1 = {}));
var M1;
...
(function(e) {
	...
	function n(r) {
		const i = r;
		return x.objectLiteral(i) && (i.tooltip === void 0 || x.string(i.tooltip) || Ht.is(i.tooltip)) && (i.location === void 0 || Lt.is(i.location)) && (i.command === void 0 || Nt.is(i.command));
	}
	e.is = n;
})(Dr || (Dr = {}));
var O1;
(function(e) {
	...
	function n(r) {
		const i = r;
		return x.objectLiteral(i) && Y.is(i.position) && (x.string(i.label) || x.typedArray(i.label, Dr.is)) && (i.kind === void 0 || Vr.is(i.kind)) && i.textEdits === void 0 || x.typedArray(i.textEdits, Pe.is) && (i.tooltip === void 0 || x.string(i.tooltip) || Ht.is(i.tooltip)) && (i.paddingLeft === void 0 || x.boolean(i.paddingLeft)) && (i.paddingRight === void 0 || x.boolean(i.paddingRight));
	}
	e.is = n;
})(O1 || (O1 = {}));
var $1;
...
(function(e) {
	function t(n) {
		const r = n;
		return x.objectLiteral(r) && Ar.is(r.uri) && x.string(r.name);
	}
	e.is = t;
})(H1 || (H1 = {}));
var z1;
...
var G1 = class Or {
	...
	update(t, n) {
		for (let r of t) if (Or.isIncremental(r)) {
			const i = Ha(r.range), s = this.offsetAt(i.start), a = this.offsetAt(i.end);
		...
		} else if (Or.isFull(r)) this._content = r.text, this._lineOffsets = void 0;
...
(function(e) {
	function t(i, s, a, l) {
		return new G1(i, s, a, l);
	}
	e.create = t;
	function n(i, s, a) {
		if (i instanceof G1) return i.update(s, a), i;
		throw new Error("TextDocument.update: document must be created by TextDocument.create");
	}
	e.update = n;
	function r(i, s) {
		let a = i.getText(), l = $r(s.map(Mc), (h, f) => {
			let g = h.range.start.line - f.range.start.line;
			return g === 0 ? h.range.start.character - f.range.start.character : g;
		}), o = 0;
		const u = [];
...
(function(e) {
	e.LATEST = { textDocument: { completion: { completionItem: {
		documentationFormat: [nt.Markdown, nt.PlainText],
...
var Ec = /{([^}]+)}/g;
function Tc(e, t) {
	return Object.keys(t).length === 0 ? e : e.replace(Ec, (n, r) => t[r] ?? n);
}
const Pc = {
	"color-hex": {
...
var Ja = class {
	...
	getNodeFromOffset(e, t = !1) {
		if (this.root) return Nc(this.root, e, t);
	}
	visit(e) {
		if (this.root) {
			const t = (n) => {
	...
	validate(e, t, n = ye.Warning, r) {
		if (this.root && t) {
			const i = new le();
			return se(this.root, t, i, zt.instance, new Z1(r ?? Y1(t))), i.problems.map((s) => {
				const a = j.create(e.positionAt(s.location.offset), e.positionAt(s.location.offset + s.location.length));
	...
	getMatchingSchemas(e, t = -1, n) {
		if (this.root && e) {
			const r = new $c(t, n), i = new Z1(Y1(e));
			return se(this.root, e, new le(), r, i), r.schemas;
		}
		return [];
	}
};
function Y1(e, t = ke.v2020_12) {
	let n = e.$schema;
	return n ? Oc[n] ?? t : t;
}
function se(e, t, n, r, i) {
	if (!e || !r.include(e)) return;
	if (e.type === "property") return se(e.valueNode, t, n, r, i);
	const s = e;
	switch (a(), s.type) {
		case "object":
			h(s);
	...
	function a() {
		...
		if (Array.isArray(t.type) ? t.type.some(f) || n.problems.push({
			...
			se(s, pe(N), b, w, i), n.merge(b), r.merge(w);
		}
		const g = pe(t.not);
		if (g) {
			const N = new le(), b = r.newSub();
			se(s, g, N, b, i), N.hasProblems() || n.problems.push({
				location: {
					offset: s.offset,
					length: s.length
				},
		...
		const m = (N, b) => {
			...
			let y;
			for (const A of N) {
				const _ = pe(A), T = new le(), I = r.newSub();
				if (se(s, _, T, I, i), T.hasProblems() || w.push(_), !y) y = {
					schema: _,
					validationResult: T,
					matchingSchemas: I
				};
		...
		const d = (N) => {
			...
			const y = pe(N), A = new le(), _ = r.newSub();
			se(s, y, A, _, i), r.merge(_), n.mergeProcessedProperties(A), A.hasProblems() ? w && d(w) : b && d(b);
		}, v = pe(t.if);
		if (v && p(v, pe(t.then), pe(t.else)), Array.isArray(t.enum)) {
			const N = tt(s);
			let b = !1;
	...
	function o(f) {
		if (oe(t.minLength) && Ys(f.value) < t.minLength && n.problems.push({
			location: {
				offset: f.offset,
				length: f.length
			},
			message: E("String is shorter than the minimum length of {0}.", t.minLength)
		}), oe(t.maxLength) && Ys(f.value) > t.maxLength && n.problems.push({
			location: {
				offset: f.offset,
				length: f.length
			},
			message: E("String is longer than the maximum length of {0}.", t.maxLength)
		}), Wa(t.pattern) && (Mn(t.pattern)?.test(f.value) || n.problems.push({
			location: {
				offset: f.offset,
				length: f.length
			},
	...
	function u(f) {
		...
		if (g !== void 0) {
			...
			for (; d < N; d++) {
				const b = g[d], w = pe(b), y = new le(), A = f.items[d];
				A && (se(A, w, y, r, i), n.mergePropertyMatch(y)), n.processedProperties.add(String(d));
			}
		}
		if (m !== void 0 && d < f.items.length) if (typeof m == "boolean") for (m === !1 && n.problems.push({
			...
			const N = new le();
			se(f.items[d], m, N, r, i), n.mergePropertyMatch(N), n.processedProperties.add(String(d));
		}
		const p = pe(t.contains);
		if (p) {
			let N = 0;
			for (let b = 0; b < f.items.length; b++) {
				const w = f.items[b], y = new le();
				se(w, p, y, zt.instance, i), y.hasProblems() || (N++, i.schemaDraft >= ke.v2020_12 && n.processedProperties.add(String(b)));
			}
		...
		if (v !== void 0) for (let N = 0; N < f.items.length; N++) {
			if (!n.processedProperties.has(String(N))) if (v === !1) n.problems.push({
				...
				const b = new le();
				se(f.items[N], t.unevaluatedItems, b, r, i), n.mergePropertyMatch(b);
			}
	...
	function h(f) {
		...
		if (t.properties) for (const b of Object.keys(t.properties)) {
			...
			if (y) if (Ee(w)) if (w) n.propertiesMatches++, n.propertiesValueMatches++;
				...
				const A = new le();
				se(y, w, A, r, i), n.mergePropertyMatch(A);
			}
		}
				...
				for (const A of m) if (w.test(A)) {
					...
					if (_) {
						...
						if (Ee(T)) if (T) n.propertiesMatches++, n.propertiesValueMatches++;
							...
							const I = new le();
							se(_, T, I, r, i), n.mergePropertyMatch(I);
						}
					}
				}
				y.forEach(d);
		...
		if (p !== void 0) for (const b of m) {
			...
			if (w) {
				if (p === !1) {
					...
					const y = new le();
					se(w, p, y, r, i), n.mergePropertyMatch(y);
				}
			}
		}
			...
			for (const w of m) if (!n.processedProperties.has(w)) {
				...
				if (y) {
					if (v === !1) {
						...
						const A = new le();
						se(y, v, A, r, i), n.mergePropertyMatch(A);
					}
				}
			}
			b.forEach(d);
		...
		const S = pe(t.propertyNames);
		if (S) for (const b of f.properties) {
			const w = b.keyNode;
			w && se(w, S, n, zt.instance, i);
		}
		function N(b, w) {
			if (Array.isArray(w)) for (const y of w) g[y] ? n.propertiesValueMatches++ : n.problems.push({
				...
				if (y) {
					const A = new le();
					se(f, y, A, r, i), n.mergePropertyMatch(A);
				}
			}
		}
	}
...
function Uc(e, t) {
	const n = [];
	let r = -1;
	const i = e.getText(), s = et(i, !1), a = t && t.collectComments ? [] : void 0;
	function l() {
		for (;;) {
			const y = s.scan();
			switch (h(), y) {
	...
	function o(y, A, _, T, I = ye.Error) {
		if (n.length === 0 || _ !== r) {
			const D = j.create(e.positionAt(_), e.positionAt(T));
			n.push(Be.create(D, y, I, A, e.languageId)), r = _;
		}
	}
	...
	function g(y) {
		...
		const A = new Ic(y, s.getTokenOffset());
		l();
		let _ = !1;
	...
	const m = new Gn(void 0, 0, 0);
	function d(y, A) {
		const _ = new Vc(y, s.getTokenOffset(), m);
		let T = v(_);
		if (!T) if (s.getToken() === 16) {
			u(E("Property keys must be doublequoted"), H.PropertyKeysMustBeDoublequoted);
			const D = new Gn(_, s.getTokenOffset(), s.getTokenLength());
			D.value = s.getTokenValue(), T = D, l();
		} else return;
		if (_.keyNode = T, T.value !== "//") {
			const D = A[T.value];
			D ? (o(E("Duplicate object key"), H.DuplicateKey, _.keyNode.offset, _.keyNode.offset + _.keyNode.length, ye.Warning), He(D) && o(E("Duplicate object key"), H.DuplicateKey, D.keyNode.offset, D.keyNode.offset + D.keyNode.length, ye.Warning), A[T.value] = !0) : A[T.value] = _;
		}
	...
	function p(y) {
		...
		const A = new Dc(y, s.getTokenOffset()), _ = Object.create(null);
		l();
		let T = !1;
	...
	function v(y) {
		...
		const A = new Gn(y, s.getTokenOffset());
		return A.value = s.getTokenValue(), f(A, !0);
	}
	function S(y) {
		if (s.getToken() !== 11) return;
		const A = new Fc(y, s.getTokenOffset());
	...
	function N(y) {
		switch (s.getToken()) {
			case 7: return f(new Cc(y, s.getTokenOffset()), !0);
			case 8: return f(new X1(y, !0, s.getTokenOffset()), !0);
			case 9: return f(new X1(y, !1, s.getTokenOffset()), !0);
			default: return;
		}
	}
	function b(y) {
	...
	let w;
	return l() !== 17 && (w = b(w), w ? s.getToken() !== 17 && u(E("End of file expected."), H.Undefined) : u(E("Expected a JSON object, array or literal."), H.Undefined)), new Ja(w, n, a);
}
function qr(e, t, n) {
	if (e !== null && typeof e == "object") {
		...
		if (Array.isArray(e)) {
			...
			let i = `[
`;
			for (let s = 0; s < e.length; s++) i += r + qr(e[s], r, n), s < e.length - 1 && (i += ","), i += `
`;
			return i += t + "]", i;
		} else {
...
`;
			for (let a = 0; a < i.length; a++) {
				const l = i[a];
				s += r + JSON.stringify(l) + ": " + qr(e[l], r, n), a < i.length - 1 && (s += ","), s += `
`;
			}
			return s += t + "}", s;
		}
...
var qc = class {
	...
	doComplete(e, t, n) {
		...
		let o;
		if (a && (a.type === "string" || a.type === "number" || a.type === "boolean" || a.type === "null")) o = j.create(e.positionAt(a.offset), e.positionAt(a.offset + a.length));
		else {
			let f = s - l.length;
			f > 0 && i[f - 1] === "\"" && f--, o = j.create(e.positionAt(f), t);
		}
		const u = /* @__PURE__ */ new Map(), h = {
			add: (f) => {
				...
				if (m) m.documentation || (m.documentation = f.documentation), m.detail || (m.detail = f.detail), m.labelDetails || (m.labelDetails = f.labelDetails);
					...
					f.textEdit = Pe.replace(o, f.insertText), f.label = g, u.set(g, f), r.items.push(f);
				}
			},
			setAsIncomplete: () => {
				r.isIncomplete = !0;
		...
		return this.schemaService.getSchemaForResource(e.uri, n).then((f) => {
			...
			if (a && a.type === "object") {
				...
				a.properties.forEach((b) => {
					(!p || p !== b) && u.set(b.keyNode.value, Fr.create("__"));
				});
				let S = "";
			...
			if (a.node === n && !a.inverted) {
				...
				l && Object.keys(l).forEach((u) => {
					...
					if (typeof h == "object" && !h.deprecationMessage && !h.doNotSuggest) {
						...
						h.suggestSortText !== void 0 && (f.sortText = h.suggestSortText), f.insertText && Wt(f.insertText, `$1${i}`) && (f.command = {
							title: "Suggest",
				...
				if (typeof o == "object" && !o.deprecationMessage && !o.doNotSuggest) {
					const u = (h, f = void 0) => {
						...
						o.suggestSortText !== void 0 && (g.sortText = o.suggestSortText), g.insertText && Wt(g.insertText, `$1${i}`) && (g.command = {
							title: "Suggest",
							command: "editor.action.triggerSuggest"
						}), s.add(g);
					};
	...
	getSchemaLessValueCompletions(e, t, n, r, i) {
		...
		const a = this.evaluateSeparatorAfter(r, s), l = (o) => {
			o.parent && !Ga(o.parent, n, !0) && i.add({
			...
			for (const g of f) if (g.node === n && !g.inverted && g.schema) {
				...
				if (o !== void 0) {
					...
					if (g.schema.patternProperties && !m) {
						for (const d of Object.keys(g.schema.patternProperties)) if (Mn(d)?.test(o)) {
							m = !0;
...
` + m) + g + t, o = o || u, h = u.replace(/[\n]/g, "");
	...
	getInsertTextForSnippetValue(e, t) {
		return qr(e, "", (r) => typeof r == "string" && r[0] === "^" ? r.substr(1) : JSON.stringify(r)) + t;
	}
	...
	getSuggestionKind(e) {
		...
		if (!e) return be.Value;
		switch (e) {
			case "string": return be.Value;
			case "object": return be.Module;
			case "property": return be.Property;
			default: return be.Value;
		}
	}
...
\r\v":{[,]}`.indexOf(r.charAt(n)) === -1;) n--;
	...
	findItemAtOffset(e, t, n) {
		const r = et(t.getText(), !0), i = e.items;
	...
	doesSupportMarkdown() {
		if (!Se(this.supportsMarkdown)) {
			...
			this.supportsMarkdown = Array.isArray(e) && e.indexOf(nt.Markdown) !== -1;
		}
	...
	doHover(e, t, n) {
		...
		const a = j.create(e.positionAt(s.offset), e.positionAt(s.offset + s.length)), l = (u) => ({
			contents: u,
			range: a
		}), o = Ur(i);
		...
		return this.schemaService.getSchemaForResource(e.uri, n).then((u) => {
			if (u && i) {
				...
				let f, g, m, d;
				h.every((v) => {
					if (v.node === i && !v.inverted && v.schema && (f = f || v.schema.title, g = g || v.schema.markdownDescription || Jn(v.schema.description), v.schema.enum)) {
						const S = v.schema.enum.indexOf(tt(i));
						v.schema.markdownEnumDescriptions ? m = v.schema.markdownEnumDescriptions[S] : v.schema.enumDescriptions && (m = Jn(v.schema.enumDescriptions[S])), m && (d = v.schema.enum[S], typeof d != "string" && (d = JSON.stringify(d)));
					}
					return !0;
				});
				let p = "";
				return f && (p = Jn(f)), g && (p.length > 0 && (p += `
...
var Hc = class {
	...
	doValidation(e, t, n, r) {
		...
		const i = [], s = {}, a = (o) => {
			...
			let u = n?.trailingCommas ? Yt(n.trailingCommas) : ye.Error, h = n?.comments ? Yt(n.comments) : this.commentSeverity, f = n?.schemaValidation ? Yt(n.schemaValidation) : ye.Warning, g = n?.schemaRequest ? Yt(n.schemaRequest) : ye.Warning;
			if (o) {
				const m = (d, p) => {
					if (t.root && g) {
						const v = t.root, S = v.type === "object" ? v.properties[0] : void 0;
						if (S && S.keyNode.value === "$schema") {
							const N = S.valueNode || S, b = j.create(e.positionAt(N.offset), e.positionAt(N.offset + N.length));
							a(Be.create(b, d, g, p));
						} else {
							const N = j.create(e.positionAt(v.offset), e.positionAt(v.offset + 1));
							a(Be.create(N, d, g, p));
						}
					}
				};
				...
				Xa(o.schema) && (h = void 0), Qa(o.schema) && (u = void 0);
			}
			...
			if (typeof h == "number") {
				...
				t.comments.forEach((d) => {
					a(Be.create(d, m, h, H.CommentNotPermitted));
				});
			}
			return i;
		};
		if (r) {
			const o = r.id || "schemaservice://untitled/" + zc++;
...
function Yt(e) {
	switch (e) {
		case "error": return ye.Error;
		case "warning": return ye.Warning;
		case "ignore": return;
	}
}
const K1 = 48, Gc = 57, Jc = 65, Kt = 97, Xc = 102;
function ee(e) {
	return e < K1 ? 0 : e <= Gc ? e - K1 : (e < Kt && (e += Kt - Jc), e >= Kt && e <= Xc ? e - Kt + 10 : 0);
}
function Qc(e) {
...
var Zc = class {
	...
	findDocumentSymbols(e, t, n = { resultLimit: Number.MAX_VALUE }) {
		...
		const s = e.uri;
		if ((s === "vscode://defaultsettings/keybindings.json" || Wt(s.toLowerCase(), "/user/keybindings.json")) && r.type === "array") {
			const f = [];
			for (const g of r.items) if (g.type === "object") {
				for (const m of g.properties) if (m.keyNode.value === "key" && m.valueNode) {
					const d = Lt.create(e.uri, Ue(e, g));
					if (f.push({
						name: ea(m.valueNode),
						kind: Re.Function,
						location: d
		...
		const u = [], h = (f, g) => {
			f.type === "array" ? f.items.forEach((m) => {
				...
				if (d) if (i > 0) {
					i--;
					const p = Lt.create(e.uri, Ue(e, m)), v = g ? g + "." + m.keyNode.value : m.keyNode.value;
					u.push({
	...
	findDocumentSymbols2(e, t, n = { resultLimit: Number.MAX_VALUE }) {
		...
		if ((s === "vscode://defaultsettings/keybindings.json" || Wt(s.toLowerCase(), "/user/keybindings.json")) && r.type === "array") {
			...
			for (const g of r.items) if (g.type === "object") {
				for (const m of g.properties) if (m.keyNode.value === "key" && m.valueNode) {
					const d = Ue(e, g), p = Ue(e, m.keyNode);
					if (f.push({
						name: ea(m.valueNode),
						kind: Re.Function,
						range: d,
		...
		const h = (f, g) => {
			f.type === "array" ? f.items.forEach((m, d) => {
				...
				if (d) if (i > 0) {
					i--;
					const p = Ue(e, m), v = Ue(e, m.keyNode), S = [], N = {
						name: this.getKeyLabel(m),
						kind: this.getSymbolKind(d.type),
						range: p,
						selectionRange: v,
	...
	getSymbolKind(e) {
		switch (e) {
			case "object": return Re.Module;
			case "string": return Re.String;
			case "number": return Re.Number;
			case "array": return Re.Array;
			case "boolean": return Re.Boolean;
			default: return Re.Variable;
		}
	}
	getKeyLabel(e) {
	...
	getColorPresentations(e, t, n, r) {
		...
		return n.alpha === 1 ? u = `#${o(s)}${o(a)}${o(l)}` : u = `#${o(s)}${o(a)}${o(l)}${o(Math.round(n.alpha * 255))}`, i.push({
			label: u,
			textEdit: Pe.replace(r, JSON.stringify(u))
		}), i;
	}
};
function Ue(e, t) {
	...
	(() => {
		...
		class g {
			...
			constructor(L, R, P, C, F, V = !1) {
				typeof L == "object" ? (this.scheme = L.scheme || u, this.authority = L.authority || u, this.path = L.path || u, this.query = L.query || u, this.fragment = L.fragment || u) : (this.scheme = (function(q, G) {
					return q || G ? q : "file";
				})(L, V), this.authority = R || u, this.path = (function(q, G) {
					switch (q) {
						case "https":
						case "http":
		...
		function v(M, L, R) {
			...
			for (let F = 0; F < M.length; F++) {
				...
				if (V >= 97 && V <= 122 || V >= 65 && V <= 90 || V >= 48 && V <= 57 || V === 45 || V === 46 || V === 95 || V === 126 || L && V === 47 || R && V === 91 || R && V === 93 || R && V === 58) C !== -1 && (P += encodeURIComponent(M.substring(C, F)), C = -1), P !== void 0 && (P += M.charAt(F));
					...
					const q = p[V];
					q !== void 0 ? (C !== -1 && (P += encodeURIComponent(M.substring(C, F)), C = -1), P += q) : C === -1 && (C = F);
				}
			}
		...
		function b(M, L) {
			const R = L ? S : v;
			let P = "", { scheme: C, authority: F, path: V, query: q, fragment: G } = M;
			if (C && (P += C, P += ":"), (F || C === "file") && (P += h, P += h), F) {
				let W = F.indexOf("@");
				if (W !== -1) {
					const ve = F.substr(0, W);
					F = F.substr(W + 1), W = ve.lastIndexOf(":"), W === -1 ? P += R(ve, !1, !1) : (P += R(ve.substr(0, W), !1, !1), P += ":", P += R(ve.substr(W + 1), !1, !0)), P += "@";
				}
			...
			return q && (P += "?", P += R(q, !1, !1)), G && (P += "#", P += L ? G : v(G, !1, !1)), P;
		}
		function w(M) {
			try {
...
var n0 = class {
	constructor(e, t, n) {
		...
		try {
			for (let r of e) {
				const i = r[0] !== e0;
				i || (r = r.substring(1)), r.length > 0 && (r[0] === t0 && (r = r.substring(1)), this.globWrappers.push({
					regexp: Kc("**/" + r, {
						extended: !0,
						globstar: !0
					}),
	...
	constructor(e, t, n) {
		this.service = e, this.uri = t, this.dependencies = /* @__PURE__ */ new Set(), this.anchors = void 0, n && (this.unresolvedSchema = this.service.promise.resolve(new Dt(n)));
	}
	getUnresolvedSchema() {
	...
	getSectionRecursive(e, t) {
		...
		if (t.patternProperties) {
			for (const r of Object.keys(t.patternProperties)) if (Mn(r)?.test(n)) return this.getSectionRecursive(e, t.patternProperties[r]);
		} else {
	...
	setSchemaContributions(e) {
		...
		if (Array.isArray(e.schemaAssociations)) {
			...
			for (let n of t) {
				const r = n.uris.map(qe), i = this.addFilePatternAssociation(n.pattern, n.folderUri, r);
				this.contributionAssociations.push(i);
			}
		}
	}
	addSchemaHandle(e, t) {
		const n = new r0(this, e, t);
	...
	getResolvedSchema(e) {
		const t = qe(e), n = this.schemasById[t];
		return n ? n.getResolvedSchema() : this.promise.resolve(void 0);
	}
	loadSchema(e) {
		if (!this.requestService) {
			const t = E("Unable to load schema from '{0}'. No schema request service available", Pt(e));
			return this.promise.resolve(new Dt({}, [t]));
		}
		return e.startsWith("http://json-schema.org/") && (e = "https" + e.substring(4)), this.requestService(e).then((t) => {
			if (!t) return new Dt({}, [E("Unable to load schema from '{0}': No content.", Pt(e))]);
			const n = [];
			t.charCodeAt(0) === 65279 && (n.push(E("Problem reading content from '{0}': UTF-8 with BOM detected, only UTF 8 is allowed.", Pt(e))), t = t.trimStart());
			let r = {};
			const i = [];
			return r = Lc(t, i), i.length && n.push(E("Unable to parse content from '{0}': Parse error at offset {1}.", Pt(e), i[0].offset)), new Dt(r, n);
		}, (t) => {
			let n = t.toString();
			const r = t.toString().split("Error: ");
			return r.length > 1 && (n = r[1]), Wt(n, ".") && (n = n.substr(0, n.length - 1)), new Dt({}, [E("Unable to load schema from '{0}': {1}.", Pt(e), n)]);
		});
	}
	resolveSchemaContent(e, t) {
		const n = e.errors.slice(0), r = e.schema;
		let i = r.$schema ? qe(r.$schema) : void 0;
		if (i === "http://json-schema.org/draft-03/schema") return this.promise.resolve(new ta({}, [E("Draft-03 schemas are not supported.")], [], i));
		...
		const a = this.contextService, l = (d, p) => {
			...
			a && !/^[A-Za-z][A-Za-z0-9+\-.+]*:\/\/.*/.test(p) && (p = a.resolveRelativePath(p, S.uri)), p = qe(p);
			...
			return this.traverseNodes(d, (v) => {
				const S = v.$id || v.id, N = Wa(S) && S.charAt(0) === "#" ? S.substring(1) : v.$anchor;
		...
		return g(r, r, t).then((d) => {
			let p = [];
			return s.size && p.push(E("The schema uses meta-schema features ({0}) that are not yet supported by the validator.", Array.from(s.keys()).join(", "))), new ta(r, n, p, i);
		});
	}
	traverseNodes(e, t) {
		if (!e || typeof e != "object") return Promise.resolve(null);
		const n = /* @__PURE__ */ new Set(), r = (...u) => {
			for (const h of u) He(h) && l.push(h);
		}, i = (...u) => {
			for (const h of u) if (He(h)) for (const f in h) {
				const g = h[f];
				He(g) && l.push(g);
			}
		}, s = (...u) => {
			for (const h of u) if (Array.isArray(h)) for (const f of h) He(f) && l.push(f);
		}, a = (u) => {
			if (Array.isArray(u)) for (const h of u) He(h) && l.push(h);
			else He(u) && l.push(u);
		}, l = [e];
		let o = l.pop();
	...
	getAssociatedSchemas(e) {
		const t = Object.create(null), n = [], r = Ya(e);
	...
	getMatchingSchemas(e, t, n) {
		if (n) {
			const r = n.id || "schemaservice://untitled/matchingSchemas/" + s0++;
...
function o0(e, t, n) {
	function r(l) {
		...
		let f;
		for (let g = h.length - 1; g >= 0; g--) f = Cn.create(h[g], f);
		return f || (f = Cn.create(j.create(l, l))), f;
	}
	function i(l, o) {
		return j.create(e.positionAt(l), e.positionAt(o));
	}
	const s = et(e.getText(), !0);
	function a(l, o) {
...
`,
	...
	return kc(e.getText(), r, i).map((s) => Pe.replace(j.create(e.positionAt(s.offset), e.positionAt(s.offset + s.length)), s.content));
}
var ie;
(function(e) {
...
var en = class {
	...
	addChildProperty(e) {
		if (e.parent = this, this.childrenProperties.length > 0) {
			let t = 0;
			e.noKeyName ? t = this.childrenProperties.length : t = u0(this.childrenProperties, e, l0), t < 0 && (t = t * -1 - 1), this.childrenProperties.splice(t, 0, e);
...
function c0(e, t) {
	const n = {
		...t,
		keepLines: !1
	}, r = xe.applyEdits(e, Wr(e, n, void 0)), i = xe.create("test://test.json", "json", 0, r), s = h0(i, f0(i)), a = Wr(s, n, void 0), l = xe.applyEdits(s, a);
	return [Pe.replace(j.create(Y.create(0, 0), e.positionAt(e.getText().length)), l)];
}
function f0(e) {
	const t = et(e.getText(), !1);
	let n = new en(), r = n, i = n, s = n, a, l = 0, o = 0, u, h, f = -1, g = -1, m = 0, d = 0, p = [], v = !1, S = !1;
	for (; (a = t.scan()) !== 17;) {
		...
		if (S === !0 && a !== 14 && a !== 15 && a !== 12 && a !== 13 && (m = t.getTokenStartLine(), S = !1), t.getTokenStartLine() !== l) {
			for (let N = l; N < t.getTokenStartLine(); N++) {
				const b = e.getText(j.create(Y.create(N, 0), Y.create(N + 1, 0))).length;
				o = o + b;
			}
		...
		switch (a) {
			case 10:
				if (u === void 0 || u === 1 || u === 5 && p[p.length - 1] === ie.Object) {
					const N = new en(t.getTokenValue(), m);
...
function h0(e, t) {
	...
	const n = xe.create("test://test.json", "json", 0, e.getText()), r = [];
	for (na(r, t, t.beginningLineNumber); r.length > 0;) {
		const i = r.shift(), s = i.propertyTreeArray;
		let a = i.beginningLineNumber;
		for (let l = 0; l < s.length; l++) {
			const o = s[l], u = j.create(Y.create(o.beginningLineNumber, 0), Y.create(o.endLineNumber + 1, 0)), h = e.getText(u), f = xe.create("test://test.json", "json", 0, h);
			if (o.lastProperty === !0 && l !== s.length - 1) {
				const d = o.lineWhereToAddComma - o.beginningLineNumber, p = o.indexWhereToAddComa, v = {
					range: j.create(Y.create(d, p), Y.create(d, p)),
					text: ","
				};
				xe.update(f, [v], 1);
			} else if (o.lastProperty === !1 && l === s.length - 1) {
				const d = o.commaIndex, p = o.commaLine - o.beginningLineNumber, v = {
					range: j.create(Y.create(p, d), Y.create(p, d + 1)),
					text: ""
				};
				xe.update(f, [v], 1);
			}
			const g = o.endLineNumber - o.beginningLineNumber + 1, m = {
				range: j.create(Y.create(a, 0), Y.create(a + g, 0)),
				text: f.getText()
			};
			xe.update(n, [m], 1), na(r, o, a), a = a + g;
		}
	}
	return n;
}
...
function Ka(e, t, n) {
	for (const r of t.childrenProperties) {
		if (r.type === ie.Object) {
			...
			e.push(new eo(n + r.beginningLineNumber - t.beginningLineNumber + s, r.childrenProperties));
		}
		r.type === ie.Array && Ka(e, r, n + r.beginningLineNumber - t.beginningLineNumber);
	}
}
var eo = class {
	constructor(e, t) {
...
function p0(e) {
	return e === "#" ? [] : e[0] !== "#" || e[1] !== "/" ? null : e.substring(2).split(/\//).map(b0);
}
function b0(e) {
	return e.replace(/~1/g, "/").replace(/~0/g, "~");
}
function y0(e) {
	const t = e.promiseConstructor || Promise, n = new i0(e.schemaRequestService, e.workspaceContext, t);
	n.setSchemaContributions(jr);
	const r = new qc(n, e.contributions, t, e.clientCapabilities), i = new jc(n, e.contributions, t), s = new Zc(n), a = new Hc(n, t);
	return {
		configure: (l) => {
		...
		parseJSONDocument: (l) => Uc(l, { collectComments: !0 }),
		newJSONDocument: (l, o) => Bc(l, o),
		...
		getFoldingRanges: a0,
		getSelectionRanges: o0,
		findDefinition: () => Promise.resolve([]),
		findLinks: m0,
		format: (l, o, u) => Wr(l, u, o),
		sort: (l, o) => c0(l, o)
	};
}
let to;
typeof fetch < "u" && (to = function(e) {
	return fetch(e).then((t) => t.text());
});
var v0 = class {
	constructor(e, t) {
		this._ctx = e, this._languageSettings = t.languageSettings, this._languageId = t.languageId, this._languageService = y0({
			workspaceContext: { resolveRelativePath: (n, r) => L0(r.substr(0, r.lastIndexOf("/") + 1), n) },
			schemaRequestService: t.enableSchemaRequest ? to : void 0,
			clientCapabilities: Br.LATEST
	...
	_getTextDocument(e) {
		...
		for (let n of t) if (n.uri.toString() === e) return xe.create(e, this._languageId, n.version, n.getValue());
		return null;
	}
};
const w0 = 47, Xn = 46;
function _0(e) {
	return e.charCodeAt(0) === w0;
}
function L0(e, t) {
	if (_0(t)) {
		const n = At.parse(e), r = t.split("/");
...
function no(e) {
	const t = [];
	for (const r of e) r.length === 0 || r.length === 1 && r.charCodeAt(0) === Xn || (r.length === 2 && r.charCodeAt(0) === Xn && r.charCodeAt(1) === Xn ? t.pop() : t.push(r));
	e.length > 1 && e[e.length - 1].length === 0 && t.push("");
	let n = t.join("/");
	return e[0].length === 0 && (n = "/" + n), n;
}
function N0(e, ...t) {
	const n = At.parse(e), r = n.path.split("/");
...
//# sourceMappingURL=json.worker-BotikA3Z.js.map